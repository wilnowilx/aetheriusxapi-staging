import{j as e,r as u,u as w,C as K,S as k,O as X}from"./r3f-DD-zEP2Y.js";import{u as Q}from"./index-Degx19WR.js";import{p as A,e as U,q as G,r as q,F as N,s as $,h as z,D as J}from"./three-DAA57BSS.js";import"./gsap-CzGW6FVa.js";const O=500;function Z({reputationParticles:m}){const y=u.useRef();m.length;const{positions:h,colors:b,sizes:v,alphas:g,types:p}=u.useMemo(()=>{const r=new Float32Array(O*3),n=new Float32Array(O*3),o=new Float32Array(O),t=new Float32Array(O),a=new Float32Array(O);for(let c=0;c<O;c++)r[c*3]=0,r[c*3+1]=0,r[c*3+2]=0,n[c*3]=0,n[c*3+1]=0,n[c*3+2]=0,o[c]=0,t[c]=0,a[c]=0;return{positions:r,colors:n,sizes:o,alphas:t,types:a}},[]);return w((r,n)=>{if(!y.current)return;const{positions:o,colors:t,sizes:a,alphas:c,types:s}=y.current.geometry.attributes;for(let l=0;l<Math.min(m.length,O);l++){const i=m[l];o.array[l*3]=i.position[0],o.array[l*3+1]=i.position[1],o.array[l*3+2]=i.position[2];const M=new U(i.color);t.array[l*3]=M.r,t.array[l*3+1]=M.g,t.array[l*3+2]=M.b;const f=i.age/i.maxAge,d=f<.1?f/.1:1,S=f>.7?(1-f)/.3:1,C=Math.min(d,S);a.array[l]=i.size*(1+f*.5)*C,c.array[l]=C*(.6+.4*Math.sin(Date.now()*.003+l)),s.array[l]=i.isBatch?1:0}for(let l=m.length;l<O;l++)c.array[l]=0,a.array[l]=0;o.needsUpdate=!0,t.needsUpdate=!0,a.needsUpdate=!0,c.needsUpdate=!0,s.needsUpdate=!0}),e.jsxs("points",{ref:y,renderOrder:15,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[h,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[b,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[v,1]}),e.jsx("bufferAttribute",{attach:"attributes-aAlpha",args:[g,1]}),e.jsx("bufferAttribute",{attach:"attributes-aType",args:[p,1]})]}),e.jsx("shaderMaterial",{vertexShader:`

import{j as e,r as f,u as P,C as q,S as B,O as X}from"./r3f-DD-zEP2Y.js";import{u as K}from"./index-40lbfjHf.js";import{p as C,e as O,q as G,r as Y,F as w,s as $,D as J,h as Q}from"./three-DAA57BSS.js";import"./gsap-CzGW6FVa.js";const S=500;function Z({reputationParticles:v}){const g=f.useRef();v.length;const{positions:m,colors:b,sizes:p,alphas:x,types:d}=f.useMemo(()=>{const r=new Float32Array(S*3),s=new Float32Array(S*3),o=new Float32Array(S),t=new Float32Array(S),a=new Float32Array(S);for(let n=0;n<S;n++)r[n*3]=0,r[n*3+1]=0,r[n*3+2]=0,s[n*3]=0,s[n*3+1]=0,s[n*3+2]=0,o[n]=0,t[n]=0,a[n]=0;return{positions:r,colors:s,sizes:o,alphas:t,types:a}},[]);return P((r,s)=>{if(!g.current)return;const{positions:o,colors:t,sizes:a,alphas:n,types:i}=g.current.geometry.attributes;for(let l=0;l<Math.min(v.length,S);l++){const c=v[l];o.array[l*3]=c.position[0],o.array[l*3+1]=c.position[1],o.array[l*3+2]=c.position[2];const y=new O(c.color);t.array[l*3]=y.r,t.array[l*3+1]=y.g,t.array[l*3+2]=y.b;const u=c.age/c.maxAge,M=u<.1?u/.1:1,E=u>.7?(1-u)/.3:1,A=Math.min(M,E);a.array[l]=c.size*(1+u*.5)*A,n.array[l]=A*(.6+.4*Math.sin(Date.now()*.003+l)),i.array[l]=c.isBatch?1:0}for(let l=v.length;l<S;l++)n.array[l]=0,a.array[l]=0;o.needsUpdate=!0,t.needsUpdate=!0,a.needsUpdate=!0,n.needsUpdate=!0,i.needsUpdate=!0}),e.jsxs("points",{ref:g,renderOrder:15,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[m,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[b,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[p,1]}),e.jsx("bufferAttribute",{attach:"attributes-aAlpha",args:[x,1]}),e.jsx("bufferAttribute",{attach:"attributes-aType",args:[d,1]})]}),e.jsx("shaderMaterial",{vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function tt(){const v=K();return v.length===0?null:e.jsx(Z,{reputationParticles:v})}const et=({liveData:v})=>{const g=f.useRef(),m=f.useRef(0),b=f.useMemo(()=>{const o=v||{};return[{radius:3.3,tilt:.18,yOffset:.55,speed:.025,bandWidth:.75,color:"#ffffff",opacity:.95,fontSize:120,text:"   THE MARKETPLACE THAT LIVES   THE MARKETPLACE THAT LIVES   THE MARKETPLACE THAT LIVES   "},{radius:2.85,tilt:.32,yOffset:-.15,speed:-.035,bandWidth:.65,color:"#d946ef",opacity:.9,fontSize:72,text:"   API INFRASTRUCTURE FOR AI AGENTS THAT PAY   API INFRASTRUCTURE FOR AI AGENTS THAT PAY   API INFRASTRUCTURE FOR AI AGENTS THAT PAY   "},{radius:2.45,tilt:.12,yOffset:-.75,speed:.04,bandWidth:.58,color:"#22d3ee",opacity:.85,fontSize:48,text:`   ${o.endpoints||"100+"} ENDPOINTS  ${o.freeEndpoints||"40"} FREE  ${o.latency||""}   ${o.endpoints||"100+"} ENDPOINTS  ${o.freeEndpoints||"40"} FREE  ${o.latency||""}   `}]},[v]),p=f.useMemo(()=>b.map(o=>{const t=document.createElement("canvas");t.width=4096,t.height=512;const a=t.getContext("2d");a.clearRect(0,0,t.width,t.height);const n=`900 ${o.fontSize*1.1}px 'JetBrains Mono', 'Fira Code', monospace`;a.font=n,a.textAlign="center",a.textBaseline="middle";const i=o.text,l=a.measureText(i).width,c=Math.ceil((t.width+l)/l),y=(t.width-l*c)/2+l/2;a.shadowColor=o.color,a.shadowBlur=64,a.fillStyle=o.color,a.globalAlpha=.5;for(let M=0;M<c;M++)a.fillText(i,y+M*l,t.height/2);a.shadowBlur=32,a.globalAlpha=.8;for(let M=0;M<c;M++)a.fillText(i,y+M*l,t.height/2);a.shadowBlur=8,a.globalAlpha=1,a.fillStyle=o.color==="#ffffff"?"#ffffff":o.color;for(let M=0;M<c;M++)a.fillText(i,y+M*l,t.height/2);a.shadowBlur=0,a.fillStyle="#ffffff",a.globalAlpha=.7;for(let M=0;M<c;M++)a.fillText(i,y+M*l,t.height/2);a.globalAlpha=1;const u=new G(t);return u.anisotropy=8,u.minFilter=$,u.magFilter=$,u}),[b]),x=f.useMemo(()=>b.map(o=>{const t=document.createElement("canvas");t.width=4096,t.height=512;const a=t.getContext("2d");a.clearRect(0,0,t.width,t.height),a.font=`900 ${o.fontSize*1.1}px 'JetBrains Mono', 'Fira Code', monospace`,a.textAlign="center",a.textBaseline="middle";const n=o.text,i=a.measureText(n).width,l=Math.ceil((t.width+i)/i),c=(t.width-i*l)/2+i/2;a.shadowColor=o.color,a.shadowBlur=28,a.fillStyle=o.color,a.globalAlpha=.35;for(let u=0;u<l;u++)a.fillText(n,c+u*i,t.height/2);a.globalAlpha=1;const y=new G(t);return y.anisotropy=4,y}),[b]),[d,r]=f.useState(null),s=f.useRef(0);return P((o,t)=>{m.current+=t,s.current+=t,g.current&&b.forEach((a,n)=>{const i=g.current.children[n];if(i){d===n||(i.rotation.y+=t*a.speed);const c=i.children[0];if(c!=null&&c.material){const y=.88+.12*Math.sin(s.current*.7+n*1.2);c.material.opacity=(d===n?1:a.opacity)*y}}})}),e.jsx("group",{ref:g,children:b.map((o,t)=>e.jsxs("group",{position:[0,o.yOffset,0],rotation:[o.tilt,0,0],children:[e.jsxs("mesh",{onPointerOver:a=>{a.stopPropagation(),r(t),document.body.style.cursor="pointer"},onPointerOut:()=>{r(null),document.body.style.cursor="auto"},onClick:()=>{},children:[e.jsx("cylinderGeometry",{args:[o.radius,o.radius,o.bandWidth,128,1,!0]}),e.jsx("meshBasicMaterial",{map:p[t],transparent:!0,opacity:o.opacity,side:w,depthWrite:!1,blending:C,toneMapped:!1})]}),e.jsxs("mesh",{children:[e.jsx("cylinderGeometry",{args:[o.radius-.01,o.radius-.01,o.bandWidth*.92,128,1,!0]}),e.jsx("meshBasicMaterial",{color:"#030308",transparent:!0,opacity:.85,side:w,depthWrite:!0})]}),e.jsxs("mesh",{children:[e.jsx("cylinderGeometry",{args:[o.radius,o.radius,o.bandWidth,128,1,!0]}),e.jsx("meshBasicMaterial",{map:x[t],transparent:!0,opacity:.22,side:Y,depthWrite:!1,blending:C,toneMapped:!1})]}),e.jsxs("mesh",{children:[e.jsx("torusGeometry",{args:[o.radius,o.bandWidth*.03,6,128]}),e.jsx("meshBasicMaterial",{color:o.color,transparent:!0,opacity:d===t?o.opacity*.18:o.opacity*.04,depthWrite:!1})]})]},t))})};function ot(){const v=f.useMemo(()=>({time:{value:0},colorA:{value:new O(2282478)},colorB:{value:new O(11032055)},colorC:{value:new O(14239471)}}),[]);return P((g,m)=>{v.time.value+=m*.6}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[2.65,28,20]}),e.jsx("shaderMaterial",{uniforms:v,vertexShader:`
        ...
        `,side:w,transparent:!0,depthWrite:!1,blending:C})]})}function at(){const v=f.useMemo(()=>({time:{value:0}}),[]);return P((g,m)=>{v.time.value+=m*.4}),e.jsxs("mesh",{scale:.85,children:[e.jsx("sphereGeometry",{args:[2.2,32,32]}),e.jsx("shaderMaterial",{uniforms:v,vertexShader:`
        ...
        `,side:w,transparent:!0,depthWrite:!1,blending:C})]})}function rt(){const v=f.useRef(),g=f.useMemo(()=>({time:{value:0}}),[]);return P((m,b)=>{g.time.value+=b*.5}),e.jsxs("mesh",{ref:v,children:[e.jsx("sphereGeometry",{args:[2.2,36,24]}),e.jsx("shaderMaterial",{uniforms:g,vertexShader:`
          varying vec3 vPos;
          uniform float time;
          void main() {
            vPos = position;
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function it({flowRef:v}){const g=f.useRef(),m=f.useRef(0),b=f.useMemo(()=>{const x=document.createElement("canvas");x.width=512,x.height=128;const d=x.getContext("2d");return d.clearRect(0,0,512,128),d.font="bold 72px monospace",d.textAlign="center",d.textBaseline="middle",d.fillStyle="#0052FF",d.shadowColor="#0052FF",d.shadowBlur=30,d.fillText("BASE",256,64),d.shadowBlur=0,d.fillText("BASE",256,64),new G(x)},[]);P((x,d)=>{var s;m.current+=d;const r=(v==null?void 0:v.current)||{pulse:.3};if(r.pulse=Math.max(.25,(r.pulse||0)-d*1.6),g.current){g.current.rotation.y=m.current*.08,g.current.rotation.x=Math.sin(m.current*.12)*.08;const o=Math.sin(m.current*1.5),t=Math.sin(m.current*.9)*.03,a=r.pulse,n=1+.04*o+.18*a;g.current.scale.set(n,n,n),g.current.position.y=t;const i=(s=g.current.children[0])==null?void 0:s.material;i&&(i.opacity=.7+.18*o+.18*a)}});const p=f.useMemo(()=>({time:{value:0},flow:{value:1},pulse:{value:0}}),[]);return P((x,d)=>{var r,s;p.time.value+=d*.5,p.flow.value=((r=v==null?void 0:v.current)==null?void 0:r.intensity)||1,p.pulse.value=((s=v==null?void 0:v.current)==null?void 0:s.pulse)||.3}),e.jsxs("group",{ref:g,scale:1.3,children:[e.jsxs("mesh",{renderOrder:0,children:[e.jsx("sphereGeometry",{args:[1.5,24,18]}),e.jsx("shaderMaterial",{uniforms:p,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:w})]}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[.62,24,18]}),e.jsx("shaderMaterial",{uniforms:p,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float flow; uniform float pulse;
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:w})]}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[.88,16,12]}),e.jsx("shaderMaterial",{uniforms:p,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              alpha *= smoothstep(1.0, 0.3, dist);
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:w})]}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[1.45,20,16]}),e.jsx("shaderMaterial",{uniforms:p,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float pulse;
            void main(){
          ...
          `,transparent:!0,depthWrite:!1,blending:C})]}),d.map((r,s)=>e.jsxs("mesh",{ref:o=>b.current[s]=o,position:r.position,children:[e.jsx("planeGeometry",{args:[1,1]}),e.jsx("shaderMaterial",{uniforms:{color:{value:new O(r.color[0],r.color[1],r.color[2])},scaleVal:{value:r.scale}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:C,side:J})]},s))]})}function lt({liveData:v,onImpact:g,flowRef:m}){const p=f.useRef(0),x=f.useRef(),d=2.2,r=d*d,s=i=>{var M;const l=Math.random()*Math.PI*2,c=Math.acos(2*Math.random()-1),y=Math.max(.5,Math.min(1.8,((M=m==null?void 0:m.current)==null?void 0:M.intensity)||1)),u=(1.6+Math.random()*1)*(.9+.3*y);i[0]=Math.sin(c)*Math.cos(l)*u,i[1]=Math.sin(c)*Math.sin(l)*u,i[2]=Math.cos(c)*u},o=(i,l,c)=>{Math.random()<.5?(i[c*3]=0,i[c*3+1]=.85,i[c*3+2]=1,l[c]=.04+Math.random()*.03):(i[c*3]=0,i[c*3+1]=.4,i[c*3+2]=1,l[c]=.035+Math.random()*.03)},t=f.useMemo(()=>{const i=new Float32Array(156),l=new Float32Array(156),c=new Float32Array(156),y=new Float32Array(52),u=new Float32Array(52),M=new Float32Array(52),E=new Uint8Array(52);for(let A=0;A<52;A++){const j=Math.random()*.08,_=Math.random()*Math.PI*2,T=Math.acos(2*Math.random()-1);i[A*3]=j*Math.sin(T)*Math.cos(_),i[A*3+1]=j*Math.sin(T)*Math.sin(_),i[A*3+2]=j*Math.cos(T);const z=Math.random()*Math.PI*2,F=Math.acos(2*Math.random()-1),N=1.6+Math.random()*1;l[A*3]=Math.sin(F)*Math.cos(z)*N,l[A*3+1]=Math.sin(F)*Math.sin(z)*N,l[A*3+2]=Math.cos(F)*N,o(c,y,A),u[A]=Math.random()*1.5,M[A]=1.8+Math.random()*.8}return{positions:i,velocities:l,colors:c,sizes:y,lifetimes:u,maxLifetimes:M,hit:E}},[]),a=f.useMemo(()=>({time:{value:0},flow:{value:1}}),[]),n=f.useRef(0);return P((i,l)=>{var D,k;p.current+=l,a.time.value=p.current;const c=Math.max(.5,Math.min(1.8,((D=m==null?void 0:m.current)==null?void 0:D.intensity)||1));a.flow.value=c;const y=((k=m==null?void 0:m.current)==null?void 0:k.pulse)>.95&&p.current-n.current>1.2;y&&(n.current=p.current);const{positions:u,velocities:M,colors:E,sizes:A,lifetimes:j,maxLifetimes:_,hit:T}=t,z=[0,0,0];let F=!1,N=y?8:0;for(let h=0;h<52;h++){j[h]+=l;const L=N>0&&j[h]>.15;if(j[h]>=_[h]||L){L&&N--;const I=Math.random()*.08,U=Math.random()*Math.PI*2,W=Math.acos(2*Math.random()-1);u[h*3]=I*Math.sin(W)*Math.cos(U),u[h*3+1]=I*Math.sin(W)*Math.sin(U),u[h*3+2]=I*Math.cos(W),s(z),M[h*3]=z[0],M[h*3+1]=z[1],M[h*3+2]=z[2],o(E,A,h),F=!0,j[h]=0,_[h]=1.8+Math.random()*.8,T[h]=0;continue}const V=Math.sqrt(u[h*3]*u[h*3]+u[h*3+1]*u[h*3+1]+u[h*3+2]*u[h*3+2]),R=V>1.6?(V-1.6)/.6:0;R>0&&(M[h*3]*=1-R*.08,M[h*3+1]*=1-R*.08,M[h*3+2]*=1-R*.08,A[h]=A[h]*(1+R*.8)),u[h*3]+=M[h*3]*l,u[h*3+1]+=M[h*3+1]*l,u[h*3+2]+=M[h*3+2]*l;const H=u[h*3]*u[h*3]+u[h*3+1]*u[h*3+1]+u[h*3+2]*u[h*3+2];if(H>=r)if(T[h])A[h]*=1.06;else{T[h]=1;const I=Math.sqrt(H),U=d/I;u[h*3]*=U,u[h*3+1]*=U,u[h*3+2]*=U,M[h*3]=0,M[h*3+1]=0,M[h*3+2]=0,g&&g({position:new Q(u[h*3],u[h*3+1],u[h*3+2]),intensity:1}),j[h]=_[h]-.8}}x.current&&(x.current.geometry.attributes.position.needsUpdate=!0,F&&(x.current.geometry.attributes.aColor.needsUpdate=!0,x.current.geometry.attributes.aSize.needsUpdate=!0))}),e.jsxs("points",{ref:x,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[t.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[t.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[t.sizes,1]})]}),e.jsx("shaderMaterial",{uniforms:a,vertexShader:`
          attribute float aSize; attribute vec3 aColor;

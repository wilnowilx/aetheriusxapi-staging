import{j as t,r as h,u as j,C as $,S as D,O as X}from"./r3f-DmFIH1pg.js";import{u as K}from"./index-aaBlcuI8.js";import{p as C,e as O,q as J,E as Q,r as Z,F as z,D as W,s as Y,t as L,h as tt}from"./three-CkYadfcZ.js";import"./gsap-CzGW6FVa.js";const w=500;function et({reputationParticles:g}){const x=h.useRef();g.length;const{positions:f,colors:M,sizes:u,alphas:m,types:l}=h.useMemo(()=>{const o=new Float32Array(w*3),a=new Float32Array(w*3),r=new Float32Array(w),e=new Float32Array(w),s=new Float32Array(w);for(let n=0;n<w;n++)o[n*3]=0,o[n*3+1]=0,o[n*3+2]=0,a[n*3]=0,a[n*3+1]=0,a[n*3+2]=0,r[n]=0,e[n]=0,s[n]=0;return{positions:o,colors:a,sizes:r,alphas:e,types:s}},[]);return j((o,a)=>{if(!x.current)return;const{positions:r,colors:e,sizes:s,alphas:n,types:i}=x.current.geometry.attributes;for(let c=0;c<Math.min(g.length,w);c++){const d=g[c];r.array[c*3]=d.position[0],r.array[c*3+1]=d.position[1],r.array[c*3+2]=d.position[2];const b=new O(d.color);e.array[c*3]=b.r,e.array[c*3+1]=b.g,e.array[c*3+2]=b.b;const p=d.age/d.maxAge,y=p<.1?p/.1:1,E=p>.7?(1-p)/.3:1,A=Math.min(y,E);s.array[c]=d.size*(1+p*.5)*A,n.array[c]=A*(.6+.4*Math.sin(Date.now()*.003+c)),i.array[c]=d.isBatch?1:0}for(let c=g.length;c<w;c++)n.array[c]=0,s.array[c]=0;r.needsUpdate=!0,e.needsUpdate=!0,s.needsUpdate=!0,n.needsUpdate=!0,i.needsUpdate=!0}),t.jsxs("points",{ref:x,renderOrder:15,children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[f,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[M,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[u,1]}),t.jsx("bufferAttribute",{attach:"attributes-aAlpha",args:[m,1]}),t.jsx("bufferAttribute",{attach:"attributes-aType",args:[l,1]})]}),t.jsx("shaderMaterial",{vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function ot(){const g=K();return g.length===0?null:t.jsx(et,{reputationParticles:g})}const at=({liveData:g})=>{const x=h.useRef();h.useRef(0);const f=h.useMemo(()=>{const l=g||{};return[{radius:2.8,tilt:.18,yOffset:.4,speed:.01,bandWidth:.35,color:"#ffffff",opacity:.9,fontSize:52,text:" THE MARKETPLACE THAT LIVES  THE MARKETPLACE THAT LIVES  THE MARKETPLACE THAT LIVES "},{radius:2.55,tilt:-.1,yOffset:-.1,speed:-.015,bandWidth:.28,color:"#d946ef",opacity:.82,fontSize:42,text:" API INFRASTRUCTURE FOR AI AGENTS THAT PAY  API INFRASTRUCTURE FOR AI AGENTS THAT PAY "},{radius:2.35,tilt:.06,yOffset:-.55,speed:.022,bandWidth:.22,color:"#22d3ee",opacity:.75,fontSize:34,text:` ${l.endpoints||"100+"} ENDPOINTS  ${l.freeEndpoints||"40"} FREE  ${l.endpoints||"100+"} ENDPOINTS  ${l.freeEndpoints||"40"} FREE `}]},[g]),M=h.useMemo(()=>f.map(l=>{const o=document.createElement("canvas");o.width=2048,o.height=96;const a=o.getContext("2d");a.clearRect(0,0,o.width,o.height);const r=`900 ${l.fontSize}px 'JetBrains Mono', 'Fira Code', monospace`;a.font=r,a.textAlign="center",a.textBaseline="middle";const e=l.text,s=a.measureText(e).width,n=Math.ceil((o.width+s)/s),i=(o.width-s*n)/2+s/2;a.shadowBlur=18,a.shadowColor=l.color,a.fillStyle=l.color,a.globalAlpha=.35;for(let d=0;d<n;d++)a.fillText(e,i+d*s,o.height/2);a.shadowBlur=0,a.globalAlpha=1;for(let d=0;d<n;d++)a.fillText(e,i+d*s,o.height/2);a.globalAlpha=1;const c=new Y(o);return c.anisotropy=4,c.minFilter=L,c.magFilter=L,c}),[f]),[u,m]=h.useState(null);return j((l,o)=>{x.current&&f.forEach((a,r)=>{const e=x.current.children[r];e&&(u===r||(e.rotation.y+=o*a.speed))})}),t.jsx("group",{ref:x,children:f.map((l,o)=>t.jsx("group",{position:[0,l.yOffset,0],rotation:[l.tilt,0,0],children:t.jsxs("mesh",{onPointerOver:a=>{a.stopPropagation(),m(o),document.body.style.cursor="pointer"},onPointerOut:()=>{m(null),document.body.style.cursor="auto"},onClick:()=>{},children:[t.jsx("cylinderGeometry",{args:[l.radius,l.radius,l.bandWidth,128,1,!0]}),t.jsx("meshBasicMaterial",{map:M[o],transparent:!0,opacity:l.opacity,side:W,depthWrite:!1,blending:C,toneMapped:!1})]})},o))})};function rt(){const g=h.useMemo(()=>({colorA:{value:new O(2282478)},colorB:{value:new O(11032055)},colorC:{value:new O(14239471)}}),[]);return t.jsxs("mesh",{children:[t.jsx("sphereGeometry",{args:[2.65,28,20]}),t.jsx("shaderMaterial",{uniforms:g,vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function lt({flowRef:g}){const x=h.useRef(),f=h.useRef(0),M=h.useMemo(()=>{const e=new J;e.moveTo(-.18/2,-.18/2),e.lineTo(.18/2,-.18/2),e.lineTo(.18/2,.18/2),e.lineTo(-.18/2+.072,.18/2),e.lineTo(-.18/2+.072,.18/2+.072),e.lineTo(-.18/2,.18/2+.072),e.lineTo(-.18/2,-.18/2);const s={depth:.06,bevelEnabled:!0,bevelThickness:.005,bevelSize:.005,bevelSegments:2},n=new Q(e,s);n.center();const i=-.8999999999999999/2;return{lGeometry:n,squares:[{pos:[i+.18+.06+.18/2,0,0],size:[.18,.18,.06]},{pos:[i+2*(.18+.06)+.18/2,0,0],size:[.18,.18,.06]},{pos:[i+3*(.18+.06)+.18/2,0,0],size:[.18,.18,.06]}]}},[]);j((m,l)=>{f.current+=l;const o=(g==null?void 0:g.current)||{pulse:.3};if(o.pulse=Math.max(.25,(o.pulse||0)-l*1.6),x.current){x.current.rotation.y=f.current*.08,x.current.rotation.x=Math.sin(f.current*.12)*.08;const a=Math.sin(f.current*1.5),r=Math.sin(f.current*.9)*.03,s=1+.03*a+.08*0;x.current.scale.set(s,s,s),x.current.position.y=r;const n=x.current.children[0];n!=null&&n.isGroup&&n.children.forEach(i=>{i!=null&&i.material&&(i.material.opacity=1)})}});const u=h.useMemo(()=>({time:{value:0},flow:{value:1}}),[]);return j((m,l)=>{var o;u.time.value+=l*.5,u.flow.value=((o=g==null?void 0:g.current)==null?void 0:o.intensity)||1}),t.jsxs("group",{ref:x,scale:1.3,children:[t.jsxs("mesh",{renderOrder:0,children:[t.jsx("sphereGeometry",{args:[1.5,24,18]}),t.jsx("shaderMaterial",{uniforms:u,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
          ...
          `,transparent:!0,depthWrite:!1,blending:C})]}),l.map((o,a)=>t.jsxs("mesh",{ref:r=>M.current[a]=r,position:o.position,children:[t.jsx("planeGeometry",{args:[1,1]}),t.jsx("shaderMaterial",{uniforms:{color:{value:new O(o.color[0],o.color[1],o.color[2])},scaleVal:{value:o.scale}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:C,side:W})]},a))]})}function dt({liveData:g,onImpact:x,flowRef:f}){const u=h.useRef(0),m=h.useRef(),l=2.2,o=l*l,a=i=>{var y;const c=Math.random()*Math.PI*2,d=Math.acos(2*Math.random()-1),b=Math.max(.5,Math.min(1.8,((y=f==null?void 0:f.current)==null?void 0:y.intensity)||1)),p=(1.6+Math.random()*1)*(.9+.3*b);i[0]=Math.sin(d)*Math.cos(c)*p,i[1]=Math.sin(d)*Math.sin(c)*p,i[2]=Math.cos(d)*p},r=(i,c,d)=>{Math.random()<.5?(i[d*3]=0,i[d*3+1]=.85,i[d*3+2]=1,c[d]=.04+Math.random()*.03):(i[d*3]=0,i[d*3+1]=.4,i[d*3+2]=1,c[d]=.035+Math.random()*.03)},e=h.useMemo(()=>{const i=new Float32Array(105),c=new Float32Array(105),d=new Float32Array(105),b=new Float32Array(35),p=new Float32Array(35),y=new Float32Array(35),E=new Uint8Array(35);for(let A=0;A<35;A++){const S=Math.random()*.08,_=Math.random()*Math.PI*2,P=Math.acos(2*Math.random()-1);i[A*3]=S*Math.sin(P)*Math.cos(_),i[A*3+1]=S*Math.sin(P)*Math.sin(_),i[A*3+2]=S*Math.cos(P);const T=Math.random()*Math.PI*2,F=Math.acos(2*Math.random()-1),N=1.6+Math.random()*1;c[A*3]=Math.sin(F)*Math.cos(T)*N,c[A*3+1]=Math.sin(F)*Math.sin(T)*N,c[A*3+2]=Math.cos(F)*N,r(d,b,A),p[A]=Math.random()*1.5,y[A]=1.8+Math.random()*.8}return{positions:i,velocities:c,colors:d,sizes:b,lifetimes:p,maxLifetimes:y,hit:E}},[]),s=h.useMemo(()=>({time:{value:0},flow:{value:1}}),[]),n=h.useRef(0);return j((i,c)=>{var V,B;u.current+=c,s.time.value=u.current;const d=Math.max(.5,Math.min(1.8,((V=f==null?void 0:f.current)==null?void 0:V.intensity)||1));s.flow.value=d;const b=((B=f==null?void 0:f.current)==null?void 0:B.pulse)>.95&&u.current-n.current>1.2;b&&(n.current=u.current);const{positions:p,velocities:y,colors:E,sizes:A,lifetimes:S,maxLifetimes:_,hit:P}=e,T=[0,0,0];let F=!1,N=b?2:0;for(let v=0;v<35;v++){S[v]+=c;const k=N>0&&S[v]>.15;if(S[v]>=_[v]||k){k&&N--;const I=Math.random()*.08,U=Math.random()*Math.PI*2,G=Math.acos(2*Math.random()-1);p[v*3]=I*Math.sin(G)*Math.cos(U),p[v*3+1]=I*Math.sin(G)*Math.sin(U),p[v*3+2]=I*Math.cos(G),a(T),y[v*3]=T[0],y[v*3+1]=T[1],y[v*3+2]=T[2],r(E,A,v),F=!0,S[v]=0,_[v]=1.8+Math.random()*.8,P[v]=0;continue}const H=Math.sqrt(p[v*3]*p[v*3]+p[v*3+1]*p[v*3+1]+p[v*3+2]*p[v*3+2]),R=H>1.6?(H-1.6)/.6:0;R>0&&(y[v*3]*=1-R*.08,y[v*3+1]*=1-R*.08,y[v*3+2]*=1-R*.08,A[v]=A[v]*(1+R*.8)),p[v*3]+=y[v*3]*c,p[v*3+1]+=y[v*3+1]*c,p[v*3+2]+=y[v*3+2]*c;const q=p[v*3]*p[v*3]+p[v*3+1]*p[v*3+1]+p[v*3+2]*p[v*3+2];if(q>=o)if(P[v])A[v]*=.92;else{P[v]=1;const I=Math.sqrt(q),U=l/I;p[v*3]*=U,p[v*3+1]*=U,p[v*3+2]*=U,y[v*3]=0,y[v*3+1]=0,y[v*3+2]=0,x&&x({position:new tt(p[v*3],p[v*3+1],p[v*3+2]),intensity:1}),S[v]=_[v]-.8}}m.current&&(m.current.geometry.attributes.position.needsUpdate=!0,F&&(m.current.geometry.attributes.aColor.needsUpdate=!0,m.current.geometry.attributes.aSize.needsUpdate=!0))}),t.jsxs("points",{ref:m,children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[e.positions,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[e.colors,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[e.sizes,1]})]}),t.jsx("shaderMaterial",{uniforms:s,vertexShader:`
          attribute float aSize; attribute vec3 aColor;
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function vt(){const{positions:x,colors:f,sizes:M}=h.useMemo(()=>{const m=new Float32Array(135),l=new Float32Array(135),o=new Float32Array(45);for(let a=0;a<45;a++){const r=Math.acos(-1+2*a/45),e=Math.sqrt(45*Math.PI)*r,s=2.35;m[a*3]=s*Math.cos(e)*Math.sin(r),m[a*3+1]=s*Math.sin(e)*Math.sin(r),m[a*3+2]=s*Math.cos(r);const n=a>=36;if(n)l[a*3]=.133,l[a*3+1]=.827,l[a*3+2]=.933;else{const i=new O().setHSL(.75+Math.random()*.1,.7,.6);l[a*3]=i.r,l[a*3+1]=i.g,l[a*3+2]=i.b}o[a]=n?.09:.055}return{positions:m,colors:l,sizes:o}},[]),u=h.useMemo(()=>({time:{value:0}}),[]);return j((m,l)=>{u.time.value+=l*1.5}),t.jsxs("points",{children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[x,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[f,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[M,1]})]}),t.jsx("shaderMaterial",{uniforms:u,vertexShader:`
          attribute float aSize; attribute vec3 aColor;
          varying vec3 vColor; varying float vAlpha;
          void main() {
            vColor = aColor;
    ...
    float fbm(vec2 p) {
      ...
      return v;
          ...
          `,transparent:!0,depthWrite:!1,blending:C})]})]})}function Mt({liveData:g,paused:x}){const f=h.useMemo(()=>typeof window>"u"?!1:window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768,[]),M=h.useCallback(r=>{window.__aetherius_addImpact&&window.__aetherius_addImpact(r)},[]),u=h.useRef({intensity:1,pulse:.4,block:null});h.useEffect(()=>{const r=()=>{const s=g||{},n=parseFloat(String(s.volume||"").replace(/[^0-9.]/g,""))||0,i=parseFloat(String(s.gas||"").replace(/[^0-9.]/g,""))||0;let c=.9+Math.min(n/500,.5)+Math.min(i/50,.25)+Math.random()*.15;c=Math.max(.6,Math.min(1.8,c));const d=u.current;d.intensity=c,s.block&&s.block!=="—"&&s.block!==d.block?(d.block=s.block,d.pulse=1):d.pulse=Math.max(.3,(d.pulse||.3)*.94)};r();const e=setInterval(r,400);return()=>clearInterval(e)},[g]);const m=h.useMemo(()=>({position:[0,.3,10.5],fov:40}),[]),l=h.useMemo(()=>({alpha:!0,antialias:!f,powerPreference:"high-performance"}),[f]),o=h.useMemo(()=>({position:"absolute",inset:0,width:"100%",height:"100%",background:"transparent"}),[]),a=h.useMemo(()=>[1,1.5],[]);return t.jsxs($,{camera:m,gl:l,onCreated:({gl:r})=>r.setClearColor(0,0),style:o,dpr:a,frameloop:x?"demand":"always",children:[t.jsx("ambientLight",{intensity:.05}),t.jsxs("group",{scale:1.3,children:[t.jsx(lt,{flowRef:u}),t.jsx(dt,{liveData:g,onImpact:M,flowRef:u}),t.jsx(at,{liveData:g}),t.jsx(it,{}),t.jsx(rt,{}),t.jsx(st,{}),t.jsx(vt,{}),t.jsx(ht,{}),t.jsx(ot,{})]}),!f&&t.jsxs(t.Fragment,{children:[t.jsx(pt,{}),t.jsx(D,{radius:12,depth:30,count:350,factor:1.2,saturation:.15,fade:!0,speed:.12}),t.jsx(D,{radius:8,depth:15,count:180,factor:.6,saturation:.2,fade:!0,speed:.08}),t.jsx(D,{radius:20,depth:50,count:80,factor:.5,saturation:.1,fade:!0,speed:.05}),t.jsx(ct,{}),t.jsx(ut,{})]}),t.jsx(X,{autoRotate:!0,autoRotateSpeed:1,enableZoom:!1,enablePan:!1,enableDamping:!0,dampingFactor:.08,rotateSpeed:.5,minPolarAngle:Math.PI*.25,maxPolarAngle:Math.PI*.75})]})}export{Mt as default};

import{r as u,j as t,C as H,S as $,O as J,u as j}from"./r3f-CXKTQSI4.js";import{q as R,p as C,F,e as N,r as q,h as w,s as K}from"./three-EcoeoGv6.js";const Q=({liveData:p})=>{const f=u.useRef(),n=u.useRef(0),b=u.useMemo(()=>{const i=p||{};return[{radius:3.6,tilt:.18,yOffset:.45,speed:.025,bandWidth:.42,color:"#ffffff",opacity:.9,fontSize:44,text:"THE MARKETPLACE   THAT LIVES   "},{radius:3.05,tilt:.32,yOffset:-.15,speed:-.035,bandWidth:.36,color:"#d946ef",opacity:.78,fontSize:34,text:"API INFRASTRUCTURE   FOR AI AGENTS   THAT PAY   "},{radius:2.55,tilt:.12,yOffset:-.55,speed:.04,bandWidth:.32,color:"#22d3ee",opacity:.68,fontSize:28,text:`${i.endpoints||"100+"} ENDPOINTS   ${i.freeEndpoints||"40"} FREE   ${i.latency||"—"}   `}]},[p]),g=u.useMemo(()=>b.map(i=>{const e=document.createElement("canvas");e.width=4096,e.height=160;const o=e.getContext("2d");o.clearRect(0,0,e.width,e.height);const M=`900 ${i.fontSize*1.35}px 'JetBrains Mono', 'Fira Code', monospace`;o.font=M,o.textAlign="center",o.textBaseline="middle";const l=i.text,v=o.measureText(l).width,c=Math.ceil((e.width+v)/v),y=(e.width-v*c)/2+v/2;o.shadowColor=i.color,o.shadowBlur=48,o.fillStyle=i.color;for(let x=0;x<c;x++)o.fillText(l,y+x*v,e.height/2);o.shadowBlur=22;for(let x=0;x<c;x++)o.fillText(l,y+x*v,e.height/2);o.shadowBlur=0,o.fillStyle=i.color==="#ffffff"?"#ffffff":i.color;for(let x=0;x<c;x++)o.fillText(l,y+x*v,e.height/2);o.fillStyle="#ffffff",o.globalAlpha=.85;for(let x=0;x<c;x++)o.fillText(l,y+x*v,e.height/2);o.globalAlpha=1;const h=new R(e);return h.anisotropy=8,h.minFilter=q,h.magFilter=q,h}),[b]),d=u.useMemo(()=>b.map(i=>{const e=document.createElement("canvas");e.width=4096,e.height=160;const o=e.getContext("2d");o.clearRect(0,0,e.width,e.height),o.font=`900 ${i.fontSize*1.35}px 'JetBrains Mono', 'Fira Code', monospace`,o.textAlign="center",o.textBaseline="middle";const M=i.text,l=o.measureText(M).width,v=Math.ceil((e.width+l)/l),c=(e.width-l*v)/2+l/2;o.shadowColor=i.color,o.shadowBlur=28,o.fillStyle=i.color,o.globalAlpha=.35;for(let h=0;h<v;h++)o.fillText(M,c+h*l,e.height/2);o.globalAlpha=1;const y=new R(e);return y.anisotropy=4,y}),[b]),[a,m]=u.useState(null),r=u.useRef(0);return j((i,e)=>{n.current+=e,r.current+=e,f.current&&b.forEach((o,M)=>{const l=f.current.children[M];if(l){a===M||(l.rotation.y+=e*o.speed);const c=l.children[0];if(c!=null&&c.material){const y=.88+.12*Math.sin(r.current*.7+M*1.2);c.material.opacity=(a===M?1:o.opacity)*y}}})}),t.jsx("group",{ref:f,children:b.map((i,e)=>t.jsxs("group",{position:[0,i.yOffset,0],rotation:[i.tilt,0,0],children:[t.jsxs("mesh",{onPointerOver:o=>{o.stopPropagation(),m(e),document.body.style.cursor="pointer"},onPointerOut:()=>{m(null),document.body.style.cursor="auto"},onClick:()=>{window.__aetherius_addImpact&&window.__aetherius_addImpact({position:new w(i.radius,i.yOffset,0),intensity:.8})},children:[t.jsx("cylinderGeometry",{args:[i.radius,i.radius,i.bandWidth,128,1,!0]}),t.jsx("meshBasicMaterial",{map:g[e],transparent:!0,opacity:i.opacity,side:F,depthWrite:!1,blending:C,toneMapped:!1})]}),t.jsxs("mesh",{children:[t.jsx("cylinderGeometry",{args:[i.radius,i.radius,i.bandWidth,128,1,!0]}),t.jsx("meshBasicMaterial",{map:d[e],transparent:!0,opacity:.22,side:K,depthWrite:!1,blending:C,toneMapped:!1})]}),t.jsxs("mesh",{children:[t.jsx("torusGeometry",{args:[i.radius,i.bandWidth*.06,6,128]}),t.jsx("meshBasicMaterial",{color:i.color,transparent:!0,opacity:i.opacity*.12,depthWrite:!1})]})]},e))})};function Y(){const p=u.useMemo(()=>({time:{value:0},colorA:{value:new N(2282478)},colorB:{value:new N(11032055)},colorC:{value:new N(14239471)}}),[]);return j((f,n)=>{p.time.value+=n*.6}),t.jsxs("mesh",{children:[t.jsx("sphereGeometry",{args:[2.65,28,20]}),t.jsx("shaderMaterial",{uniforms:p,vertexShader:`
        ...
        `,side:F,transparent:!0,depthWrite:!1,blending:C})]})}function Z(){const p=u.useMemo(()=>({time:{value:0}}),[]);return j((f,n)=>{p.time.value+=n*.4}),t.jsxs("mesh",{scale:.85,children:[t.jsx("sphereGeometry",{args:[2.2,32,32]}),t.jsx("shaderMaterial",{uniforms:p,vertexShader:`
        ...
        `,side:F,transparent:!0,depthWrite:!1,blending:C})]})}function X({impactPoints:p}){const f=u.useRef(),n=u.useMemo(()=>({time:{value:0},impact0:{value:new w(0,0,0)},i0t:{value:0},impact1:{value:new w(0,0,0)},i1t:{value:0},impact2:{value:new w(0,0,0)},i2t:{value:0},impact3:{value:new w(0,0,0)},i3t:{value:0},impact4:{value:new w(0,0,0)},i4t:{value:0},impact5:{value:new w(0,0,0)},i5t:{value:0},impact6:{value:new w(0,0,0)},i6t:{value:0},impact7:{value:new w(0,0,0)},i7t:{value:0}}),[]);return j((b,g)=>{if(n.time.value+=g*.5,p)for(let d=0;d<8&&d<p.length;d++){const a=p[d];n[`impact${d}`].value.copy(a.position),n[`i${d}t`].value=a.intensity}}),t.jsxs("mesh",{ref:f,children:[t.jsx("sphereGeometry",{args:[2.2,36,24]}),t.jsx("shaderMaterial",{uniforms:n,vertexShader:`
        ...
        `,wireframe:!0,transparent:!0,depthWrite:!1})]})}function tt({flowRef:p}){const f=u.useRef(),n=u.useRef(0),b=u.useMemo(()=>{const d=document.createElement("canvas");d.width=512,d.height=128;const a=d.getContext("2d");return a.clearRect(0,0,512,128),a.font="bold 72px monospace",a.textAlign="center",a.textBaseline="middle",a.fillStyle="#0052FF",a.shadowColor="#0052FF",a.shadowBlur=30,a.fillText("BASE",256,64),a.shadowBlur=0,a.fillText("BASE",256,64),new R(d)},[]);j((d,a)=>{var r;n.current+=a;const m=(p==null?void 0:p.current)||{intensity:1,pulse:.3};if(m.pulse=Math.max(.25,(m.pulse||0)-a*1.8),f.current){f.current.rotation.y=n.current*(.15+.15*m.intensity),f.current.rotation.x=n.current*.1;const i=Math.sin(n.current*1.8),e=1+.06*i+.22*m.pulse;f.current.scale.set(e,e,e);const o=(r=f.current.children[0])==null?void 0:r.material;o&&(o.opacity=.75+.2*i+.15*m.pulse)}});const g=u.useMemo(()=>({time:{value:0},flow:{value:1},pulse:{value:0}}),[]);return j((d,a)=>{var m,r;g.time.value+=a*.5,g.flow.value=((m=p==null?void 0:p.current)==null?void 0:m.intensity)||1,g.pulse.value=((r=p==null?void 0:p.current)==null?void 0:r.pulse)||.3}),t.jsxs("group",{ref:f,scale:1.3,children:[t.jsx("sprite",{scale:[2.2,.55,1],children:t.jsx("spriteMaterial",{map:b,transparent:!0,blending:C,opacity:.9,depthWrite:!1})}),t.jsxs("mesh",{children:[t.jsx("sphereGeometry",{args:[.38,32,24]}),t.jsx("shaderMaterial",{uniforms:g,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function at(){const p=u.useRef(),f=u.useMemo(()=>({time:{value:0}}),[]),n=u.useRef(0);j((a,m)=>{n.current+=m,f.time.value=n.current,p.current&&(p.current.rotation.y=n.current*.06)});const{positions:b,colors:g,sizes:d}=u.useMemo(()=>{const m=new Float32Array(150),r=new Float32Array(150),i=new Float32Array(50);for(let e=0;e<50;e++){const o=e/50*Math.PI*2,M=e%3,l=2.55+M*.22,v=.15*M;m[e*3]=l*Math.cos(o),m[e*3+1]=l*Math.sin(o)*Math.sin(v),m[e*3+2]=l*Math.sin(o)*Math.cos(v);const c=e/50;r[e*3]=.659*(1-c)+.133*c,r[e*3+1]=.333*(1-c)+.827*c,r[e*3+2]=.969*(1-c)+.933*c,i[e]=.015+Math.random()*.025}return{positions:m,colors:r,sizes:i}},[]);return t.jsx("group",{ref:p,children:t.jsxs("points",{children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[b,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[g,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[d,1]})]}),t.jsx("shaderMaterial",{uniforms:f,vertexShader:`
            attribute float aSize; attribute vec3 aColor;
            varying vec3 vColor; varying float vAlpha; uniform float time;
            void main() {
              vColor = aColor;
          ...
          `,transparent:!0,depthWrite:!1,blending:C})]})})}function it({onImpactsReady:p}){const f=u.useRef([]),n=u.useRef(Array.from({length:8},()=>({position:new w,intensity:0,active:!1,age:0})));return j((b,g)=>{for(;f.current.length>0&&n.current.some(a=>!a.active);){const a=f.current.shift(),m=n.current.find(r=>!r.active);m&&(m.position.copy(a.position),m.intensity=a.intensity,m.active=!0,m.age=0)}const d=1.5;n.current.forEach(a=>{a.active&&(a.age+=g,a.intensity=Math.max(0,1-a.age*d),a.intensity<=0&&(a.active=!1))}),p(n.current.filter(a=>a.active).map(a=>({position:a.position,intensity:a.intensity})))}),u.useEffect(()=>(window.__aetherius_addImpact=b=>{f.current.push(b)},()=>{delete window.__aetherius_addImpact}),[]),null}function st(){const[p,f]=u.useState([]),n=u.useRef(""),b=u.useCallback(g=>{let d=g.length+":";for(let a=0;a<g.length;a++){const m=g[a];d+=m.position.x.toFixed(1)+","+m.position.y.toFixed(1)+","+m.position.z.toFixed(1)+","+m.intensity.toFixed(2)+";"}d!==n.current&&(n.current=d,f(g))},[]);return t.jsxs(t.Fragment,{children:[t.jsx(X,{impactPoints:p}),t.jsx(it,{onImpactsReady:b})]})}function rt(){const p=u.useRef(),f=u.useRef(0),{positions:n,colors:b,sizes:g}=u.useMemo(()=>{const m=new Float32Array(24),r=new Float32Array(24),i=new Float32Array(8);for(let e=0;e<8;e++){const o=e/8*Math.PI*2+Math.random()*.5,M=4+Math.random()*2;m[e*3]=M*Math.cos(o),m[e*3+1]=(Math.random()-.5)*3,m[e*3+2]=M*Math.sin(o);const l=Math.random();l<.4?(r[e*3]=.13,r[e*3+1]=.82,r[e*3+2]=.93):l<.7?(r[e*3]=.84,r[e*3+1]=.27,r[e*3+2]=.93):(r[e*3]=.83,r[e*3+1]=.66,r[e*3+2]=.32),i[e]=.08+Math.random()*.06}return{positions:m,colors:r,sizes:i}},[]),d=u.useMemo(()=>({time:{value:0}}),[]);return j((a,m)=>{var i,e,o;f.current+=m,d.time.value=f.current,p.current&&(p.current.rotation.y=f.current*.02);const r=(o=(e=(i=p.current)==null?void 0:i.geometry)==null?void 0:e.attributes)==null?void 0:o.aSize;if(r){for(let M=0;M<8;M++)r.array[M]=.06+.05*Math.sin(f.current*2+M*1.5);r.needsUpdate=!0}}),t.jsxs("points",{ref:p,children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[n,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[b,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[g,1]})]}),t.jsx("shaderMaterial",{uniforms:d,vertexShader:"attribute float aSize; attribute vec3 aColor; varying vec3 vColor; varying float vAlpha; uniform float time; void main(){vColor=aColor; vAlpha=0.6+0.4*sin(time*1.2+position.x*2.0); vec4 mv=modelViewMatrix*vec4(position,1.0); gl_PointSize=aSize*(500.0/-mv.z); gl_Position=projectionMatrix*mv;}",fragmentShader:"varying vec3 vColor; varying float vAlpha; void main(){ float d=length(gl_PointCoord-vec2(0.5)); if(d>0.5)discard; float g=pow(1.0-d*2.0,1.5); gl_FragColor=vec4(vColor,g*vAlpha);}",transparent:!0,depthWrite:!1,blending:C})]})}function ct({liveData:p,paused:f}){const n=u.useMemo(()=>typeof window>"u"?!1:window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768,[]),b=u.useCallback(i=>{window.__aetherius_addImpact&&window.__aetherius_addImpact(i)},[]),g=u.useRef({intensity:1,pulse:.4,block:null});u.useEffect(()=>{const i=()=>{const o=p||{},M=parseFloat(String(o.volume||"").replace(/[^0-9.]/g,""))||0,l=parseFloat(String(o.gas||"").replace(/[^0-9.]/g,""))||0;let v=.9+Math.min(M/500,.5)+Math.min(l/50,.25)+Math.random()*.15;v=Math.max(.6,Math.min(1.8,v));const c=g.current;c.intensity=v,o.block&&o.block!=="—"&&o.block!==c.block?(c.block=o.block,c.pulse=1):c.pulse=Math.max(.3,(c.pulse||.3)*.94)};i();const e=setInterval(i,400);return()=>clearInterval(e)},[p]);const d=u.useMemo(()=>({position:[0,.3,10.5],fov:40}),[]),a=u.useMemo(()=>({alpha:!0,antialias:!n,powerPreference:"high-performance"}),[n]),m=u.useMemo(()=>({position:"absolute",inset:0,width:"100%",height:"100%",background:"transparent"}),[]),r=u.useMemo(()=>[1,1.5],[]);return t.jsxs(H,{camera:d,gl:a,onCreated:({gl:i})=>i.setClearColor(0,0),style:m,dpr:r,frameloop:f?"demand":"always",children:[t.jsx("ambientLight",{intensity:.05}),t.jsxs("group",{scale:1.3,children:[t.jsx(st,{}),t.jsx(tt,{flowRef:g}),t.jsx(et,{liveData:p,onImpact:b,flowRef:g}),t.jsx(Y,{}),t.jsx(Z,{}),t.jsx(ot,{}),t.jsx(Q,{liveData:p}),t.jsx(at,{})]}),!n&&t.jsxs(t.Fragment,{children:[t.jsx($,{radius:12,depth:30,count:600,factor:3,saturation:.3,fade:!0,speed:.12}),t.jsx($,{radius:8,depth:15,count:300,factor:1.5,saturation:.5,fade:!0,speed:.08}),t.jsx(rt,{})]}),t.jsx(J,{autoRotate:!0,autoRotateSpeed:1,enableZoom:!1,enablePan:!1,enableDamping:!0,dampingFactor:.08,rotateSpeed:.5,minPolarAngle:Math.PI*.25,maxPolarAngle:Math.PI*.75})]})}export{ct as default};

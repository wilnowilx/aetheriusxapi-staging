import{j as e,r as f,u as P,C as X,S as B,O as K}from"./r3f-DD-zEP2Y.js";import{u as J}from"./index-DBRt8tX1.js";import{p as C,e as O,q as G,r as Y,F as S,s as $,D as q,h as Q}from"./three-DAA57BSS.js";import"./gsap-CzGW6FVa.js";const w=500;function Z({reputationParticles:v}){const g=f.useRef();v.length;const{positions:m,colors:b,sizes:p,alphas:x,types:d}=f.useMemo(()=>{const r=new Float32Array(w*3),s=new Float32Array(w*3),o=new Float32Array(w),t=new Float32Array(w),a=new Float32Array(w);for(let n=0;n<w;n++)r[n*3]=0,r[n*3+1]=0,r[n*3+2]=0,s[n*3]=0,s[n*3+1]=0,s[n*3+2]=0,o[n]=0,t[n]=0,a[n]=0;return{positions:r,colors:s,sizes:o,alphas:t,types:a}},[]);return P((r,s)=>{if(!g.current)return;const{positions:o,colors:t,sizes:a,alphas:n,types:i}=g.current.geometry.attributes;for(let l=0;l<Math.min(v.length,w);l++){const c=v[l];o.array[l*3]=c.position[0],o.array[l*3+1]=c.position[1],o.array[l*3+2]=c.position[2];const y=new O(c.color);t.array[l*3]=y.r,t.array[l*3+1]=y.g,t.array[l*3+2]=y.b;const u=c.age/c.maxAge,M=u<.1?u/.1:1,E=u>.7?(1-u)/.3:1,A=Math.min(M,E);a.array[l]=c.size*(1+u*.5)*A,n.array[l]=A*(.6+.4*Math.sin(Date.now()*.003+l)),i.array[l]=c.isBatch?1:0}for(let l=v.length;l<w;l++)n.array[l]=0,a.array[l]=0;o.needsUpdate=!0,t.needsUpdate=!0,a.needsUpdate=!0,n.needsUpdate=!0,i.needsUpdate=!0}),e.jsxs("points",{ref:g,renderOrder:15,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[m,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[b,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[p,1]}),e.jsx("bufferAttribute",{attach:"attributes-aAlpha",args:[x,1]}),e.jsx("bufferAttribute",{attach:"attributes-aType",args:[d,1]})]}),e.jsx("shaderMaterial",{vertexShader:`
        ...
        `,side:S,transparent:!0,depthWrite:!1,blending:C})]})}function rt(){const v=f.useRef(),g=f.useMemo(()=>({time:{value:0}}),[]);return P((m,b)=>{g.time.value+=b*.5}),e.jsxs("mesh",{ref:v,children:[e.jsx("sphereGeometry",{args:[2.2,36,24]}),e.jsx("shaderMaterial",{uniforms:g,vertexShader:`
          varying vec3 vPos;
          uniform float time;
          void main() {
            vPos = position;

import{j as e,r as u,u as w,C as K,S as k,O as X}from"./r3f-DD-zEP2Y.js";import{u as Q}from"./index-qMSEl9ia.js";import{p as A,e as U,q as G,r as q,F as N,s as $,h as z,D as J}from"./three-DAA57BSS.js";import"./gsap-CzGW6FVa.js";const O=500;function Z({reputationParticles:m}){const M=u.useRef();m.length;const{positions:h,colors:b,sizes:v,alphas:g,types:p}=u.useMemo(()=>{const r=new Float32Array(O*3),n=new Float32Array(O*3),o=new Float32Array(O),t=new Float32Array(O),a=new Float32Array(O);for(let c=0;c<O;c++)r[c*3]=0,r[c*3+1]=0,r[c*3+2]=0,n[c*3]=0,n[c*3+1]=0,n[c*3+2]=0,o[c]=0,t[c]=0,a[c]=0;return{positions:r,colors:n,sizes:o,alphas:t,types:a}},[]);return w((r,n)=>{if(!M.current)return;const{positions:o,colors:t,sizes:a,alphas:c,types:s}=M.current.geometry.attributes;for(let l=0;l<Math.min(m.length,O);l++){const i=m[l];o.array[l*3]=i.position[0],o.array[l*3+1]=i.position[1],o.array[l*3+2]=i.position[2];const y=new U(i.color);t.array[l*3]=y.r,t.array[l*3+1]=y.g,t.array[l*3+2]=y.b;const f=i.age/i.maxAge,d=f<.1?f/.1:1,S=f>.7?(1-f)/.3:1,C=Math.min(d,S);a.array[l]=i.size*(1+f*.5)*C,c.array[l]=C*(.6+.4*Math.sin(Date.now()*.003+l)),s.array[l]=i.isBatch?1:0}for(let l=m.length;l<O;l++)c.array[l]=0,a.array[l]=0;o.needsUpdate=!0,t.needsUpdate=!0,a.needsUpdate=!0,c.needsUpdate=!0,s.needsUpdate=!0}),e.jsxs("points",{ref:M,renderOrder:15,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[h,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[b,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[v,1]}),e.jsx("bufferAttribute",{attach:"attributes-aAlpha",args:[g,1]}),e.jsx("bufferAttribute",{attach:"attributes-aType",args:[p,1]})]}),e.jsx("shaderMaterial",{vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:A})]})}function tt(){const m=Q();return m.length===0?null:e.jsx(Z,{reputationParticles:m})}const et=({liveData:m})=>{const M=u.useRef(),h=u.useRef(0),b=u.useMemo(()=>{const o=m||{};return[{radius:3.8,tilt:.18,yOffset:.55,speed:.025,bandWidth:.75,color:"#ffffff",opacity:.9,fontSize:72,text:"   THE MARKETPLACE THAT LIVES   THE MARKETPLACE THAT LIVES   THE MARKETPLACE THAT LIVES   "},{radius:3.15,tilt:.32,yOffset:-.15,speed:-.035,bandWidth:.62,color:"#d946ef",opacity:.82,fontSize:56,text:"   API INFRASTRUCTURE FOR AI AGENTS THAT PAY   API INFRASTRUCTURE FOR AI AGENTS THAT PAY   API INFRASTRUCTURE FOR AI AGENTS THAT PAY   "},{radius:2.55,tilt:.12,yOffset:-.75,speed:.04,bandWidth:.52,color:"#22d3ee",opacity:.75,fontSize:44,text:`   ${o.endpoints||"100+"} ENDPOINTS  ${o.freeEndpoints||"40"} FREE  ${o.latency||""}   ${o.endpoints||"100+"} ENDPOINTS  ${o.freeEndpoints||"40"} FREE  ${o.latency||""}   `}]},[m]),v=u.useMemo(()=>b.map(o=>{const t=document.createElement("canvas");t.width=4096,t.height=400;const a=t.getContext("2d");a.clearRect(0,0,t.width,t.height);const c=`900 ${o.fontSize*1.1}px 'JetBrains Mono', 'Fira Code', monospace`;a.font=c,a.textAlign="center",a.textBaseline="middle";const s=o.text,l=a.measureText(s).width,i=Math.ceil((t.width+l)/l),y=(t.width-l*i)/2+l/2;a.shadowColor=o.color,a.shadowBlur=64,a.fillStyle=o.color,a.globalAlpha=.5;for(let d=0;d<i;d++)a.fillText(s,y+d*l,t.height/2);a.shadowBlur=32,a.globalAlpha=.8;for(let d=0;d<i;d++)a.fillText(s,y+d*l,t.height/2);a.shadowBlur=8,a.globalAlpha=1,a.fillStyle=o.color==="#ffffff"?"#ffffff":o.color;for(let d=0;d<i;d++)a.fillText(s,y+d*l,t.height/2);a.shadowBlur=0,a.fillStyle="#ffffff",a.globalAlpha=.7;for(let d=0;d<i;d++)a.fillText(s,y+d*l,t.height/2);a.globalAlpha=1;const f=new G(t);return f.anisotropy=8,f.minFilter=$,f.magFilter=$,f}),[b]),g=u.useMemo(()=>b.map(o=>{const t=document.createElement("canvas");t.width=4096,t.height=400;const a=t.getContext("2d");a.clearRect(0,0,t.width,t.height),a.font=`900 ${o.fontSize*1.1}px 'JetBrains Mono', 'Fira Code', monospace`,a.textAlign="center",a.textBaseline="middle";const c=o.text,s=a.measureText(c).width,l=Math.ceil((t.width+s)/s),i=(t.width-s*l)/2+s/2;a.shadowColor=o.color,a.shadowBlur=28,a.fillStyle=o.color,a.globalAlpha=.35;for(let f=0;f<l;f++)a.fillText(c,i+f*s,t.height/2);a.globalAlpha=1;const y=new G(t);return y.anisotropy=4,y}),[b]),[p,r]=u.useState(null),n=u.useRef(0);return w((o,t)=>{h.current+=t,n.current+=t,M.current&&b.forEach((a,c)=>{const s=M.current.children[c];if(s){p===c||(s.rotation.y+=t*a.speed);const i=s.children[0];if(i!=null&&i.material){const y=.88+.12*Math.sin(n.current*.7+c*1.2);i.material.opacity=(p===c?1:a.opacity)*y}}})}),e.jsx("group",{ref:M,children:b.map((o,t)=>e.jsxs("group",{position:[0,o.yOffset,0],rotation:[o.tilt,0,0],children:[e.jsxs("mesh",{onPointerOver:a=>{a.stopPropagation(),r(t),document.body.style.cursor="pointer"},onPointerOut:()=>{r(null),document.body.style.cursor="auto"},onClick:()=>{window.__aetherius_addImpact&&window.__aetherius_addImpact({position:new z(o.radius,o.yOffset,0),intensity:.8})},children:[e.jsx("cylinderGeometry",{args:[o.radius,o.radius,o.bandWidth,128,1,!0]}),e.jsx("meshBasicMaterial",{map:v[t],transparent:!0,opacity:o.opacity,side:N,depthWrite:!1,blending:A,toneMapped:!1})]}),e.jsxs("mesh",{children:[e.jsx("cylinderGeometry",{args:[o.radius,o.radius,o.bandWidth,128,1,!0]}),e.jsx("meshBasicMaterial",{map:g[t],transparent:!0,opacity:.22,side:q,depthWrite:!1,blending:A,toneMapped:!1})]}),e.jsxs("mesh",{children:[e.jsx("torusGeometry",{args:[o.radius,o.bandWidth*.03,6,128]}),e.jsx("meshBasicMaterial",{color:o.color,transparent:!0,opacity:o.opacity*.04,depthWrite:!1})]})]},t))})};function at(){const m=u.useMemo(()=>({time:{value:0},colorA:{value:new U(2282478)},colorB:{value:new U(11032055)},colorC:{value:new U(14239471)}}),[]);return w((M,h)=>{m.time.value+=h*.6}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[2.65,28,20]}),e.jsx("shaderMaterial",{uniforms:m,vertexShader:`
        ...
        `,side:N,transparent:!0,depthWrite:!1,blending:A})]})}function ot(){const m=u.useMemo(()=>({time:{value:0}}),[]);return w((M,h)=>{m.time.value+=h*.4}),e.jsxs("mesh",{scale:.85,children:[e.jsx("sphereGeometry",{args:[2.2,32,32]}),e.jsx("shaderMaterial",{uniforms:m,vertexShader:`
        ...
        `,side:N,transparent:!0,depthWrite:!1,blending:A})]})}function st({impactPoints:m}){const M=u.useRef(),h=u.useMemo(()=>({time:{value:0},impact0:{value:new z(0,0,0)},i0t:{value:0},impact1:{value:new z(0,0,0)},i1t:{value:0},impact2:{value:new z(0,0,0)},i2t:{value:0},impact3:{value:new z(0,0,0)},i3t:{value:0},impact4:{value:new z(0,0,0)},i4t:{value:0},impact5:{value:new z(0,0,0)},i5t:{value:0},impact6:{value:new z(0,0,0)},i6t:{value:0},impact7:{value:new z(0,0,0)},i7t:{value:0}}),[]);return w((b,v)=>{if(h.time.value+=v*.5,m)for(let g=0;g<8&&g<m.length;g++){const p=m[g];h[`impact${g}`].value.copy(p.position),h[`i${g}t`].value=p.intensity}}),e.jsxs("mesh",{ref:M,children:[e.jsx("sphereGeometry",{args:[2.2,36,24]}),e.jsx("shaderMaterial",{uniforms:h,vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:A})]})}function it({flowRef:m}){const M=u.useRef(),h=u.useRef(0),b=u.useMemo(()=>{const g=document.createElement("canvas");g.width=512,g.height=128;const p=g.getContext("2d");return p.clearRect(0,0,512,128),p.font="bold 72px monospace",p.textAlign="center",p.textBaseline="middle",p.fillStyle="#0052FF",p.shadowColor="#0052FF",p.shadowBlur=30,p.fillText("BASE",256,64),p.shadowBlur=0,p.fillText("BASE",256,64),new G(g)},[]);w((g,p)=>{var n;h.current+=p;const r=(m==null?void 0:m.current)||{pulse:.3};if(r.pulse=Math.max(.25,(r.pulse||0)-p*1.6),M.current){M.current.rotation.y=h.current*.08,M.current.rotation.x=Math.sin(h.current*.12)*.08;const o=Math.sin(h.current*1.5),t=Math.sin(h.current*.9)*.03,a=r.pulse,c=1+.04*o+.18*a;M.current.scale.set(c,c,c),M.current.position.y=t;const s=(n=M.current.children[0])==null?void 0:n.material;s&&(s.opacity=.7+.18*o+.18*a)}});const v=u.useMemo(()=>({time:{value:0},flow:{value:1},pulse:{value:0}}),[]);return w((g,p)=>{var r,n;v.time.value+=p*.5,v.flow.value=((r=m==null?void 0:m.current)==null?void 0:r.intensity)||1,v.pulse.value=((n=m==null?void 0:m.current)==null?void 0:n.pulse)||.3}),e.jsxs("group",{ref:M,scale:1.3,children:[e.jsxs("mesh",{renderOrder:0,children:[e.jsx("sphereGeometry",{args:[1.5,24,18]}),e.jsx("shaderMaterial",{uniforms:v,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:A,side:N})]}),e.jsx(nt,{gasUniforms:v})]})}function nt({gasUniforms:m}){const g=4.840000000000001,p=u.useRef(),r=u.useRef([]),n=u.useMemo(()=>{const a=new Float32Array(21),c=new Float32Array(21),s=new Float32Array(35),l=new Float32Array(21);for(let i=0;i<7;i++){const y=i>=5;s[i*5]=1.5+Math.random()*2,s[i*5+1]=1+Math.random()*2.5,s[i*5+2]=Math.random()*3,s[i*5+3]=y?1:0,s[i*5+4]=1;const f=Math.random()*Math.PI*2,d=Math.acos(2*Math.random()-1),S=s[i*5];if(c[i*3]=Math.sin(d)*Math.cos(f)*S,c[i*3+1]=Math.sin(d)*Math.sin(f)*S,c[i*3+2]=Math.cos(d)*S,a[i*3]=(Math.random()-.5)*.04,a[i*3+1]=(Math.random()-.5)*.04,a[i*3+2]=(Math.random()-.5)*.04,y){const C=Math.random();l[i*3]=0,l[i*3+1]=.5+C*.4,l[i*3+2]=.95+C*.05}else{const C=Math.random();l[i*3]=0,l[i*3+1]=.75+C*.25,l[i*3+2]=1}}return{positions:a,velocities:c,seeds:s,colors:l}},[]);return w((a,c)=>{if(!p.current)return;const{positions:s,velocities:l,seeds:i,colors:y}=n;m.time.value,m.pulse.value;const f=[];for(let d=0;d<7;d++){const S=i[d*5+3]>.5;i[d*5+2]+=c;const C=i[d*5+2],j=i[d*5+1];if(C>=j){const T=Math.random()*Math.PI*2,P=Math.acos(2*Math.random()-1),_=1.5+Math.random()*2;l[d*3]=Math.sin(P)*Math.cos(T)*_,l[d*3+1]=Math.sin(P)*Math.sin(T)*_,l[d*3+2]=Math.cos(P)*_,s[d*3]=(Math.random()-.5)*.04,s[d*3+1]=(Math.random()-.5)*.04,s[d*3+2]=(Math.random()-.5)*.04,i[d*5]=_,i[d*5+2]=0,i[d*5+4]=1;continue}if(i[d*5+4]<.5)continue;s[d*3]+=l[d*3]*c,s[d*3+1]+=l[d*3+1]*c,s[d*3+2]+=l[d*3+2]*c;const F=S?.97:.992;l[d*3]*=F,l[d*3+1]*=F,l[d*3+2]*=F;const R=s[d*3]**2+s[d*3+1]**2+s[d*3+2]**2;if(R>=g&&i[d*5+4]>.5){const P=2.2/Math.sqrt(R);s[d*3]*=P,s[d*3+1]*=P,s[d*3+2]*=P,f.push({x:s[d*3],y:s[d*3+1],z:s[d*3+2],intensity:S?.15:.25}),S?(l[d*3]*=-.3,l[d*3+1]*=-.3,l[d*3+2]*=-.3,i[d*5+2]=i[d*5+1]-.2):(i[d*5+4]=0,i[d*5+2]=i[d*5+1]-.1)}}r.current=f,p.current.geometry.attributes.position.needsUpdate=!0}),e.jsxs("points",{ref:p,renderOrder:10,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[n.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-seeds",args:[n.seeds,5]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[n.colors,3]})]}),e.jsx("shaderMaterial",{uniforms:m,vertexShader:`
  ...
  `,transparent:!0,depthWrite:!1,blending:A})]})}function lt(){const h=u.useRef(),b=u.useRef([]),v=u.useRef(0),g=u.useMemo(()=>{const r=new Float32Array(1950),n=new Float32Array(650*3),o=new Float32Array(650);for(let t=0;t<650;t++){const a=Math.random()*Math.PI*2,c=Math.acos(2*Math.random()-1),s=4.8+Math.random()*12;r[t*3]=s*Math.sin(c)*Math.cos(a),r[t*3+1]=s*Math.sin(c)*Math.sin(a),r[t*3+2]=s*Math.cos(c);const l=Math.random();l<.5?(n[t*3]=0,n[t*3+1]=.85,n[t*3+2]=1):l<.8?(n[t*3]=0,n[t*3+1]=.4,n[t*3+2]=1):(n[t*3]=.1,n[t*3+1]=.9,n[t*3+2]=.7),o[t]=.02+Math.random()*.035}return{positions:r,colors:n,sizes:o}},[]),p=u.useMemo(()=>Array.from({length:16},()=>{const r=Math.random()*Math.PI*2,n=Math.acos(2*Math.random()-1),o=5.5+Math.random()*8.5,t=Math.random();let a;return t<.4?a=[0,.82,1]:t<.7?a=[0,.45,.95]:a=[.1,.88,.72],{position:[o*Math.sin(n)*Math.cos(r),o*Math.sin(n)*Math.sin(r),o*Math.cos(n)],scale:1.8+Math.random()*2.5,color:a,rotSpeed:(Math.random()-.5)*.02,bobSpeed:.1+Math.random()*.2,bobAmp:.2+Math.random()*.4,phase:Math.random()*Math.PI*2}}),[]);return w((r,n)=>{v.current+=n,h.current&&(h.current.rotation.y=v.current*.008),b.current.forEach((o,t)=>{if(!o)return;const a=p[t],c=v.current;o.position.x=a.position[0]+Math.sin(c*a.rotSpeed+a.phase)*a.bobAmp,o.position.y=a.position[1]+Math.cos(c*a.bobSpeed+a.phase)*a.bobAmp*.6,o.position.z=a.position[2]+Math.sin(c*a.rotSpeed*.7+a.phase*1.3)*a.bobAmp*.4})}),e.jsxs("group",{ref:h,children:[e.jsxs("points",{children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[g.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[g.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[g.sizes,1]})]}),e.jsx("shaderMaterial",{vertexShader:`
          ...
          `,transparent:!0,depthWrite:!1,blending:A})]}),p.map((r,n)=>e.jsxs("mesh",{ref:o=>b.current[n]=o,position:r.position,children:[e.jsx("planeGeometry",{args:[1,1]}),e.jsx("shaderMaterial",{uniforms:{color:{value:new U(r.color[0],r.color[1],r.color[2])},scaleVal:{value:r.scale}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:A,side:J})]},n))]})}function ct({liveData:m,onImpact:M,flowRef:h}){const v=u.useRef(0),g=u.useRef(),p=2.2,r=p*p,n=s=>{var d;const l=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1),y=Math.max(.5,Math.min(1.8,((d=h==null?void 0:h.current)==null?void 0:d.intensity)||1)),f=(1.6+Math.random()*1)*(.9+.3*y);s[0]=Math.sin(i)*Math.cos(l)*f,s[1]=Math.sin(i)*Math.sin(l)*f,s[2]=Math.cos(i)*f},o=(s,l,i)=>{Math.random()<.5?(s[i*3]=0,s[i*3+1]=.85,s[i*3+2]=1,l[i]=.04+Math.random()*.03):(s[i*3]=0,s[i*3+1]=.4,s[i*3+2]=1,l[i]=.035+Math.random()*.03)},t=u.useMemo(()=>{const s=new Float32Array(156),l=new Float32Array(156),i=new Float32Array(156),y=new Float32Array(52),f=new Float32Array(52),d=new Float32Array(52),S=new Uint8Array(52);for(let C=0;C<52;C++){const j=Math.random()*.08,F=Math.random()*Math.PI*2,R=Math.acos(2*Math.random()-1);s[C*3]=j*Math.sin(R)*Math.cos(F),s[C*3+1]=j*Math.sin(R)*Math.sin(F),s[C*3+2]=j*Math.cos(R);const T=Math.random()*Math.PI*2,P=Math.acos(2*Math.random()-1),_=1.6+Math.random()*1;l[C*3]=Math.sin(P)*Math.cos(T)*_,l[C*3+1]=Math.sin(P)*Math.sin(T)*_,l[C*3+2]=Math.cos(P)*_,o(i,y,C),f[C]=Math.random()*1.5,d[C]=1.8+Math.random()*.8}return{positions:s,velocities:l,colors:i,sizes:y,lifetimes:f,maxLifetimes:d,hit:S}},[]),a=u.useMemo(()=>({time:{value:0},flow:{value:1}}),[]),c=u.useRef(0);return w((s,l)=>{var B,D;v.current+=l,a.time.value=v.current;const i=Math.max(.5,Math.min(1.8,((B=h==null?void 0:h.current)==null?void 0:B.intensity)||1));a.flow.value=i;const y=((D=h==null?void 0:h.current)==null?void 0:D.pulse)>.95&&v.current-c.current>1.2;y&&(c.current=v.current);const{positions:f,velocities:d,colors:S,sizes:C,lifetimes:j,maxLifetimes:F,hit:R}=t,T=[0,0,0];let P=!1,_=y?8:0;for(let x=0;x<52;x++){j[x]+=l;const V=_>0&&j[x]>.15;if(j[x]>=F[x]||V){V&&_--;const W=Math.random()*.08,E=Math.random()*Math.PI*2,L=Math.acos(2*Math.random()-1);f[x*3]=W*Math.sin(L)*Math.cos(E),f[x*3+1]=W*Math.sin(L)*Math.sin(E),f[x*3+2]=W*Math.cos(L),n(T),d[x*3]=T[0],d[x*3+1]=T[1],d[x*3+2]=T[2],o(S,C,x),P=!0,j[x]=0,F[x]=1.8+Math.random()*.8,R[x]=0;continue}const H=Math.sqrt(f[x*3]*f[x*3]+f[x*3+1]*f[x*3+1]+f[x*3+2]*f[x*3+2]),I=H>1.6?(H-1.6)/.6:0;I>0&&(d[x*3]*=1-I*.08,d[x*3+1]*=1-I*.08,d[x*3+2]*=1-I*.08,C[x]=C[x]*(1+I*.8)),f[x*3]+=d[x*3]*l,f[x*3+1]+=d[x*3+1]*l,f[x*3+2]+=d[x*3+2]*l;const Y=f[x*3]*f[x*3]+f[x*3+1]*f[x*3+1]+f[x*3+2]*f[x*3+2];if(Y>=r)if(R[x])C[x]*=1.06;else{R[x]=1;const W=Math.sqrt(Y),E=p/W;f[x*3]*=E,f[x*3+1]*=E,f[x*3+2]*=E,d[x*3]=0,d[x*3+1]=0,d[x*3+2]=0,M&&M({position:new z(f[x*3],f[x*3+1],f[x*3+2]),intensity:1}),j[x]=F[x]-.8}}g.current&&(g.current.geometry.attributes.position.needsUpdate=!0,P&&(g.current.geometry.attributes.aColor.needsUpdate=!0,g.current.geometry.attributes.aSize.needsUpdate=!0))}),e.jsxs("points",{ref:g,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[t.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[t.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[t.sizes,1]})]}),e.jsx("shaderMaterial",{uniforms:a,vertexShader:`
          attribute float aSize; attribute vec3 aColor;
        ...
        `,transparent:!0,depthWrite:!1,blending:A})]})}function pt(){const{positions:M,colors:h,sizes:b}=u.useMemo(()=>{const g=new Float32Array(180),p=new Float32Array(180),r=new Float32Array(60);for(let n=0;n<60;n++){const o=Math.acos(-1+2*n/60),t=Math.sqrt(60*Math.PI)*o,a=2.35;g[n*3]=a*Math.cos(t)*Math.sin(o),g[n*3+1]=a*Math.sin(t)*Math.sin(o),g[n*3+2]=a*Math.cos(o);const c=n>=36;if(c)p[n*3]=.133,p[n*3+1]=.827,p[n*3+2]=.933;else{const s=new U().setHSL(.75+Math.random()*.1,.7,.6);p[n*3]=s.r,p[n*3+1]=s.g,p[n*3+2]=s.b}r[n]=c?.09:.055}return{positions:g,colors:p,sizes:r}},[]),v=u.useMemo(()=>({time:{value:0}}),[]);return w((g,p)=>{v.time.value+=p*1.5}),e.jsxs("points",{children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[M,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[h,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[b,1]})]}),e.jsx("shaderMaterial",{uniforms:v,vertexShader:`
          attribute float aSize; attribute vec3 aColor;
        ...
        `,transparent:!0,depthWrite:!1,blending:A})]})}function dt(){const m=u.useRef(),M=u.useMemo(()=>({time:{value:0}}),[]),h=u.useRef(0);w((p,r)=>{h.current+=r,M.time.value=h.current,m.current&&(m.current.rotation.y=h.current*.06)});const{positions:b,colors:v,sizes:g}=u.useMemo(()=>{const r=new Float32Array(150),n=new Float32Array(150),o=new Float32Array(50);for(let t=0;t<50;t++){const a=t/50*Math.PI*2,c=t%3,s=2.55+c*.22,l=.15*c;r[t*3]=s*Math.cos(a),r[t*3+1]=s*Math.sin(a)*Math.sin(l),r[t*3+2]=s*Math.sin(a)*Math.cos(l);const i=t/50;n[t*3]=.659*(1-i)+.133*i,n[t*3+1]=.333*(1-i)+.827*i,n[t*3+2]=.969*(1-i)+.933*i,o[t]=.015+Math.random()*.025}return{positions:r,colors:n,sizes:o}},[]);return e.jsx("group",{ref:m,children:e.jsxs("points",{children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[b,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[v,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[g,1]})]}),e.jsx("shaderMaterial",{uniforms:M,vertexShader:`
            attribute float aSize; attribute vec3 aColor;
            varying vec3 vColor; varying float vAlpha; uniform float time;
            void main() {
              vColor = aColor;
          ...
          `,transparent:!0,depthWrite:!1,blending:A})]})})}function ut({onImpactsReady:m}){const M=u.useRef([]),h=u.useRef(Array.from({length:8},()=>({position:new z,intensity:0,active:!1,age:0})));return w((b,v)=>{for(;M.current.length>0&&h.current.some(p=>!p.active);){const p=M.current.shift(),r=h.current.find(n=>!n.active);r&&(r.position.copy(p.position),r.intensity=p.intensity,r.active=!0,r.age=0)}const g=2.5;h.current.forEach(p=>{p.active&&(p.age+=v,p.intensity=Math.max(0,1-p.age*g),p.intensity<=0&&(p.active=!1))}),m(h.current.filter(p=>p.active).map(p=>({position:p.position,intensity:p.intensity})))}),u.useEffect(()=>(window.__aetherius_addImpact=b=>{M.current.push(b)},()=>{delete window.__aetherius_addImpact}),[]),null}function ft(){const[m,M]=u.useState([]),h=u.useRef(""),b=u.useCallback(v=>{let g=v.length+":";for(let p=0;p<v.length;p++){const r=v[p];g+=r.position.x.toFixed(1)+","+r.position.y.toFixed(1)+","+r.position.z.toFixed(1)+","+r.intensity.toFixed(2)+";"}g!==h.current&&(h.current=g,M(v))},[]);return e.jsxs(e.Fragment,{children:[e.jsx(st,{impactPoints:m}),e.jsx(ut,{onImpactsReady:b})]})}function ht(){const m=u.useRef(),M=u.useRef(0),{positions:h,colors:b,sizes:v}=u.useMemo(()=>{const r=new Float32Array(6),n=new Float32Array(6),o=new Float32Array(2);for(let t=0;t<2;t++){const a=t/2*Math.PI*2+Math.random()*.5,c=4+Math.random()*2;r[t*3]=c*Math.cos(a),r[t*3+1]=(Math.random()-.5)*3,r[t*3+2]=c*Math.sin(a);const s=Math.random();s<.4?(n[t*3]=.13,n[t*3+1]=.82,n[t*3+2]=.93):s<.7?(n[t*3]=.84,n[t*3+1]=.27,n[t*3+2]=.93):(n[t*3]=.83,n[t*3+1]=.66,n[t*3+2]=.32),o[t]=.03+Math.random()*.02}return{positions:r,colors:n,sizes:o}},[]),g=u.useMemo(()=>({time:{value:0}}),[]);return w((p,r)=>{var o,t,a;M.current+=r,g.time.value=M.current,m.current&&(m.current.rotation.y=M.current*.02);const n=(a=(t=(o=m.current)==null?void 0:o.geometry)==null?void 0:t.attributes)==null?void 0:a.aSize;if(n){for(let c=0;c<2;c++)n.array[c]=.02+.02*Math.sin(M.current*2+c*1.5);n.needsUpdate=!0}}),e.jsxs("points",{ref:m,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[h,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[b,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[v,1]})]}),e.jsx("shaderMaterial",{uniforms:g,vertexShader:"attribute float aSize; attribute vec3 aColor; varying vec3 vColor; varying float vAlpha; uniform float time; void main(){vColor=aColor; vAlpha=0.6+0.4*sin(time*1.2+position.x*2.0); vec4 mv=modelViewMatrix*vec4(position,1.0); gl_PointSize=aSize*(500.0/-mv.z); gl_Position=projectionMatrix*mv;}",fragmentShader:"varying vec3 vColor; varying float vAlpha; void main(){ float d=length(gl_PointCoord-vec2(0.5)); if(d>0.5)discard; float g=pow(1.0-d*2.0,1.5); gl_FragColor=vec4(vColor,g*vAlpha);}",transparent:!0,depthWrite:!1,blending:A})]})}function vt(){const M=u.useRef();u.useRef([]);const h=u.useRef(0),b=u.useMemo(()=>{const p=new Float32Array(1200),r=new Float32Array(400*3),n=new Float32Array(400),o=()=>Math.random();for(let t=0;t<400;t++){const a=o()*Math.PI*2,c=Math.acos(2*o()-1),s=o();let l,i;s<.45?(l=6+o()*6,i=.03):s<.8?(l=12+o()*8,i=.02):(l=20+o()*8,i=.015),p[t*3]=l*Math.sin(c)*Math.cos(a),p[t*3+1]=l*Math.sin(c)*Math.sin(a),p[t*3+2]=l*Math.cos(c);const y=o();y<.4?(r[t*3]=.95,r[t*3+1]=.97,r[t*3+2]=1):y<.55?(r[t*3]=.3,r[t*3+1]=.95,r[t*3+2]=1):y<.68?(r[t*3]=1,r[t*3+1]=1,r[t*3+2]=1):y<.78?(r[t*3]=.6,r[t*3+1]=.8,r[t*3+2]=1):y<.88?(r[t*3]=.95,r[t*3+1]=.35,r[t*3+2]=.9):(r[t*3]=1,r[t*3+1]=.82,r[t*3+2]=.55),n[t]=i+o()*.015}return{positions:p,colors:r,sizes:n}},[]),v=u.useMemo(()=>{const r=new Float32Array(36),n=new Float32Array(36),o=new Float32Array(12),t=new Float32Array(24),a=()=>Math.random();for(let c=0;c<12;c++){const s=a()*Math.PI*2,l=Math.acos(2*a()-1),i=a()<.65?6+a()*8:14+a()*9;r[c*3]=i*Math.sin(l)*Math.cos(s),r[c*3+1]=i*Math.sin(l)*Math.sin(s),r[c*3+2]=i*Math.cos(l);const y=a();let f=[0,.8,1];y<.25?f=[0,.82,1]:y<.45?f=[.1,.92,.7]:y<.6?f=[.05,.55,.95]:y<.78?f=[.15,.75,.88]:f=[.35,.15,.8],n[c*3]=f[0],n[c*3+1]=f[1],n[c*3+2]=f[2],o[c]=120+a()*140,t[c*2]=2+a()*3,t[c*2+1]=a()*100}return{positions:r,colors:n,sizes:o,noise:t}},[]);return w((p,r)=>{h.current+=r;const n=h.current;M.current&&(M.current.rotation.y=n*.0018,M.current.rotation.x=Math.sin(n*.0012)*.012)}),e.jsxs("group",{ref:M,children:[e.jsxs("points",{children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[b.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[b.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[b.sizes,1]})]}),e.jsx("shaderMaterial",{vertexShader:`
            attribute float aSize;
            attribute vec3 aColor;
            varying vec3 vColor;
            varying float vDist;

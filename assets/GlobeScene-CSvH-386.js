import{j as t,r as u,u as j,C as X,S as D,O as $}from"./r3f-DmFIH1pg.js";import{u as K}from"./index-Cb8j5-tG.js";import{p as C,e as O,q as J,E as Q,r as Z,F as z,D as W,s as Y,t as L,h as tt}from"./three-CkYadfcZ.js";import"./gsap-CzGW6FVa.js";const P=500;function et({reputationParticles:g}){const x=u.useRef();g.length;const{positions:p,colors:M,sizes:h,alphas:m,types:l}=u.useMemo(()=>{const o=new Float32Array(P*3),a=new Float32Array(P*3),r=new Float32Array(P),e=new Float32Array(P),s=new Float32Array(P);for(let n=0;n<P;n++)o[n*3]=0,o[n*3+1]=0,o[n*3+2]=0,a[n*3]=0,a[n*3+1]=0,a[n*3+2]=0,r[n]=0,e[n]=0,s[n]=0;return{positions:o,colors:a,sizes:r,alphas:e,types:s}},[]);return j((o,a)=>{if(!x.current)return;const{positions:r,colors:e,sizes:s,alphas:n,types:i}=x.current.geometry.attributes;for(let c=0;c<Math.min(g.length,P);c++){const d=g[c];r.array[c*3]=d.position[0],r.array[c*3+1]=d.position[1],r.array[c*3+2]=d.position[2];const b=new O(d.color);e.array[c*3]=b.r,e.array[c*3+1]=b.g,e.array[c*3+2]=b.b;const f=d.age/d.maxAge,y=f<.1?f/.1:1,E=f>.7?(1-f)/.3:1,A=Math.min(y,E);s.array[c]=d.size*(1+f*.5)*A,n.array[c]=A*(.6+.4*Math.sin(Date.now()*.003+c)),i.array[c]=d.isBatch?1:0}for(let c=g.length;c<P;c++)n.array[c]=0,s.array[c]=0;r.needsUpdate=!0,e.needsUpdate=!0,s.needsUpdate=!0,n.needsUpdate=!0,i.needsUpdate=!0}),t.jsxs("points",{ref:x,renderOrder:15,children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[p,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[M,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[h,1]}),t.jsx("bufferAttribute",{attach:"attributes-aAlpha",args:[m,1]}),t.jsx("bufferAttribute",{attach:"attributes-aType",args:[l,1]})]}),t.jsx("shaderMaterial",{vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function ot(){const g=K();return g.length===0?null:t.jsx(et,{reputationParticles:g})}const at=({liveData:g})=>{const x=u.useRef();u.useRef(0);const p=u.useMemo(()=>{const l=g||{};return[{radius:2.8,tilt:.18,yOffset:.4,speed:.01,bandWidth:.35,color:"#ffffff",opacity:.9,fontSize:52,text:" THE MARKETPLACE THAT LIVES  THE MARKETPLACE THAT LIVES  THE MARKETPLACE THAT LIVES "},{radius:2.55,tilt:-.1,yOffset:-.1,speed:-.015,bandWidth:.28,color:"#d946ef",opacity:.82,fontSize:42,text:" API INFRASTRUCTURE FOR AI AGENTS THAT PAY  API INFRASTRUCTURE FOR AI AGENTS THAT PAY "},{radius:2.35,tilt:.06,yOffset:-.55,speed:.022,bandWidth:.22,color:"#22d3ee",opacity:.75,fontSize:34,text:` ${l.endpoints||"100+"} ENDPOINTS  ${l.freeEndpoints||"40"} FREE  ${l.endpoints||"100+"} ENDPOINTS  ${l.freeEndpoints||"40"} FREE `}]},[g]),M=u.useMemo(()=>p.map(l=>{const o=document.createElement("canvas");o.width=2048,o.height=96;const a=o.getContext("2d");a.clearRect(0,0,o.width,o.height);const r=`900 ${l.fontSize}px 'JetBrains Mono', 'Fira Code', monospace`;a.font=r,a.textAlign="center",a.textBaseline="middle";const e=l.text,s=a.measureText(e).width,n=Math.ceil((o.width+s)/s),i=(o.width-s*n)/2+s/2;a.shadowBlur=18,a.shadowColor=l.color,a.fillStyle=l.color,a.globalAlpha=.35;for(let d=0;d<n;d++)a.fillText(e,i+d*s,o.height/2);a.shadowBlur=0,a.globalAlpha=1;for(let d=0;d<n;d++)a.fillText(e,i+d*s,o.height/2);a.globalAlpha=1;const c=new Y(o);return c.anisotropy=4,c.minFilter=L,c.magFilter=L,c}),[p]),[h,m]=u.useState(null);return j((l,o)=>{x.current&&p.forEach((a,r)=>{const e=x.current.children[r];e&&(h===r||(e.rotation.y+=o*a.speed))})}),t.jsx("group",{ref:x,children:p.map((l,o)=>t.jsx("group",{position:[0,l.yOffset,0],rotation:[l.tilt,0,0],children:t.jsxs("mesh",{onPointerOver:a=>{a.stopPropagation(),m(o),document.body.style.cursor="pointer"},onPointerOut:()=>{m(null),document.body.style.cursor="auto"},onClick:()=>{},children:[t.jsx("cylinderGeometry",{args:[l.radius,l.radius,l.bandWidth,128,1,!0]}),t.jsx("shaderMaterial",{uniforms:{uMap:{value:M[o]},uOpacity:{value:l.opacity}},vertexShader:`
                varying vec2 vUv;
                void main() {
                  vUv = uv;
              ...
              `,transparent:!0,side:W,depthWrite:!1,blending:C,toneMapped:!1})]})},o))})};function rt(){const g=u.useMemo(()=>({colorA:{value:new O(2282478)},colorB:{value:new O(11032055)},colorC:{value:new O(14239471)}}),[]);return t.jsxs("mesh",{children:[t.jsx("sphereGeometry",{args:[2.65,28,20]}),t.jsx("shaderMaterial",{uniforms:g,vertexShader:`
        ...
        `,side:z,transparent:!0,depthWrite:!1,blending:C})]})}function it(){const g=u.useRef();return t.jsxs("mesh",{ref:g,children:[t.jsx("sphereGeometry",{args:[2.2,36,24]}),t.jsx("shaderMaterial",{vertexShader:`
          varying vec3 vPos;
          void main() {
            vPos = position;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function lt({flowRef:g}){const x=u.useRef(),p=u.useRef(0),M=u.useMemo(()=>{const e=new J;e.moveTo(-.24/2,-.24/2),e.lineTo(.24/2,-.24/2),e.lineTo(.24/2,.24/2),e.lineTo(-.24/2+.096,.24/2),e.lineTo(-.24/2+.096,.24/2+.096),e.lineTo(-.24/2,.24/2+.096),e.lineTo(-.24/2,-.24/2);const s={depth:.08,bevelEnabled:!0,bevelThickness:.005,bevelSize:.005,bevelSegments:2},n=new Q(e,s),i=-1.2/2+.24/2;return{lGeometry:n,lPos:[i,0,0],squares:[{pos:[i+.24/2+.08+.24/2,0,0],size:[.24,.24,.08]},{pos:[i+.24/2+.08+.24+.08+.24/2,0,0],size:[.24,.24,.08]},{pos:[i+.24/2+.08+.24+.08+.24+.08+.24/2,0,0],size:[.24,.24,.08]}]}},[]);j((m,l)=>{p.current+=l;const o=(g==null?void 0:g.current)||{pulse:.3};if(o.pulse=Math.max(.25,(o.pulse||0)-l*1.6),x.current){x.current.rotation.y=p.current*.08,x.current.rotation.x=Math.sin(p.current*.12)*.08;const a=Math.sin(p.current*1.5),r=Math.sin(p.current*.9)*.03,s=1+.03*a+.08*0;x.current.scale.set(s,s,s),x.current.position.y=r;const n=x.current.children[0];n!=null&&n.isGroup&&n.children.forEach(i=>{i!=null&&i.material&&(i.material.opacity=1)})}});const h=u.useMemo(()=>({time:{value:0},flow:{value:1}}),[]);return j((m,l)=>{var o;h.time.value+=l*.15,h.flow.value=((o=g==null?void 0:g.current)==null?void 0:o.intensity)||1}),t.jsxs("group",{ref:x,scale:1.3,children:[t.jsxs("mesh",{renderOrder:0,children:[t.jsx("sphereGeometry",{args:[1.5,24,18]}),t.jsx("shaderMaterial",{uniforms:h,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:Z})]}),t.jsxs("mesh",{renderOrder:1,children:[t.jsx("sphereGeometry",{args:[1.2,20,14]}),t.jsx("shaderMaterial",{uniforms:h,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float flow;
            void main(){
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:z})]}),t.jsxs("mesh",{children:[t.jsx("sphereGeometry",{args:[.62,24,18]}),t.jsx("shaderMaterial",{uniforms:h,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float flow; uniform float pulse;
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:z})]}),t.jsxs("mesh",{children:[t.jsx("sphereGeometry",{args:[.88,16,12]}),t.jsx("shaderMaterial",{uniforms:h,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              alpha *= smoothstep(1.0, 0.3, dist);
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:z})]}),t.jsxs("mesh",{children:[t.jsx("sphereGeometry",{args:[1.45,20,16]}),t.jsx("shaderMaterial",{uniforms:h,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float pulse;
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:z})]})]})}function ct(){const p=u.useRef(),M=u.useRef([]),h=u.useRef(0),m=u.useMemo(()=>{const o=new Float32Array(600),a=new Float32Array(600),r=new Float32Array(200);for(let e=0;e<200;e++){const s=Math.random()*Math.PI*2,n=Math.acos(2*Math.random()-1),i=4.8+Math.random()*12;o[e*3]=i*Math.sin(n)*Math.cos(s),o[e*3+1]=i*Math.sin(n)*Math.sin(s),o[e*3+2]=i*Math.cos(n);const c=Math.random();c<.5?(a[e*3]=0,a[e*3+1]=.85,a[e*3+2]=1):c<.8?(a[e*3]=0,a[e*3+1]=.4,a[e*3+2]=1):(a[e*3]=.1,a[e*3+1]=.9,a[e*3+2]=.7),r[e]=.012+Math.random()*.02}return{positions:o,colors:a,sizes:r}},[]),l=u.useMemo(()=>Array.from({length:6},()=>{const o=Math.random()*Math.PI*2,a=Math.acos(2*Math.random()-1),r=5.5+Math.random()*8.5,e=Math.random();let s;return e<.4?s=[0,.82,1]:e<.7?s=[0,.45,.95]:s=[.1,.88,.72],{position:[r*Math.sin(a)*Math.cos(o),r*Math.sin(a)*Math.sin(o),r*Math.cos(a)],scale:1.8+Math.random()*2.5,color:s,rotSpeed:(Math.random()-.5)*.02,bobSpeed:.1+Math.random()*.2,bobAmp:.2+Math.random()*.4,phase:Math.random()*Math.PI*2}}),[]);return j((o,a)=>{h.current+=a,p.current&&(p.current.rotation.y=h.current*.008),M.current.forEach((r,e)=>{if(!r)return;const s=l[e],n=h.current;r.position.x=s.position[0]+Math.sin(n*s.rotSpeed+s.phase)*s.bobAmp,r.position.y=s.position[1]+Math.cos(n*s.bobSpeed+s.phase)*s.bobAmp*.6,r.position.z=s.position[2]+Math.sin(n*s.rotSpeed*.7+s.phase*1.3)*s.bobAmp*.4})}),t.jsxs("group",{ref:p,children:[t.jsxs("points",{children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[m.positions,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[m.colors,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[m.sizes,1]})]}),t.jsx("shaderMaterial",{vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function vt(){const{positions:x,colors:p,sizes:M}=u.useMemo(()=>{const m=new Float32Array(135),l=new Float32Array(135),o=new Float32Array(45);for(let a=0;a<45;a++){const r=Math.acos(-1+2*a/45),e=Math.sqrt(45*Math.PI)*r,s=2.35;m[a*3]=s*Math.cos(e)*Math.sin(r),m[a*3+1]=s*Math.sin(e)*Math.sin(r),m[a*3+2]=s*Math.cos(r);const n=a>=36;if(n)l[a*3]=.133,l[a*3+1]=.827,l[a*3+2]=.933;else{const i=new O().setHSL(.75+Math.random()*.1,.7,.6);l[a*3]=i.r,l[a*3+1]=i.g,l[a*3+2]=i.b}o[a]=n?.09:.055}return{positions:m,colors:l,sizes:o}},[]),h=u.useMemo(()=>({time:{value:0}}),[]);return j((m,l)=>{h.time.value+=l*1.5}),t.jsxs("points",{children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[x,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[p,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[M,1]})]}),t.jsx("shaderMaterial",{uniforms:h,vertexShader:`
          attribute float aSize; attribute vec3 aColor;
          varying vec3 vColor; varying float vAlpha;
          void main() {
            vColor = aColor;
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function ut(){const g=u.useRef(),x=u.useMemo(()=>({time:{value:0}}),[]),p=u.useRef(0);j((l,o)=>{p.current+=o,x.time.value=p.current,g.current&&(g.current.rotation.y=p.current*.06)});const{positions:M,colors:h,sizes:m}=u.useMemo(()=>{const o=new Float32Array(90),a=new Float32Array(90),r=new Float32Array(30);for(let e=0;e<30;e++){const s=e/30*Math.PI*2,n=e%3,i=2.55+n*.22,c=.15*n;o[e*3]=i*Math.cos(s),o[e*3+1]=i*Math.sin(s)*Math.sin(c),o[e*3+2]=i*Math.sin(s)*Math.cos(c);const d=e/30;a[e*3]=.659*(1-d)+.133*d,a[e*3+1]=.333*(1-d)+.827*d,a[e*3+2]=.969*(1-d)+.933*d,r[e]=.015+Math.random()*.025}return{positions:o,colors:a,sizes:r}},[]);return t.jsx("group",{ref:g,children:t.jsxs("points",{children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[M,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[h,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[m,1]})]}),t.jsx("shaderMaterial",{uniforms:x,vertexShader:`
            attribute float aSize; attribute vec3 aColor;
            varying vec3 vColor; varying float vAlpha;
            void main() {
              vColor = aColor;
          ...
          `,transparent:!0,depthWrite:!1,blending:C})]})})}function ht(){const g=u.useRef(),x=u.useRef(0),{positions:p,colors:M,sizes:h}=u.useMemo(()=>{const o=new Float32Array(6),a=new Float32Array(6),r=new Float32Array(2);for(let e=0;e<2;e++){const s=e/2*Math.PI*2+Math.random()*.5,n=4+Math.random()*2;o[e*3]=n*Math.cos(s),o[e*3+1]=(Math.random()-.5)*3,o[e*3+2]=n*Math.sin(s);const i=Math.random();i<.4?(a[e*3]=.13,a[e*3+1]=.82,a[e*3+2]=.93):i<.7?(a[e*3]=.84,a[e*3+1]=.27,a[e*3+2]=.93):(a[e*3]=.83,a[e*3+1]=.66,a[e*3+2]=.32),r[e]=.03+Math.random()*.02}return{positions:o,colors:a,sizes:r}},[]),m=u.useMemo(()=>({time:{value:0}}),[]);return j((l,o)=>{var r,e,s;x.current+=o,m.time.value=x.current,g.current&&(g.current.rotation.y=x.current*.02);const a=(s=(e=(r=g.current)==null?void 0:r.geometry)==null?void 0:e.attributes)==null?void 0:s.aSize;if(a){for(let n=0;n<2;n++)a.array[n]=.03;a.needsUpdate=!0}}),t.jsxs("points",{ref:g,children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[p,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[M,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[h,1]})]}),t.jsx("shaderMaterial",{uniforms:m,vertexShader:"attribute float aSize; attribute vec3 aColor; varying vec3 vColor; varying float vAlpha; void main(){vColor=aColor; vAlpha=0.6; vec4 mv=modelViewMatrix*vec4(position,1.0); gl_PointSize=aSize*(500.0/-mv.z); gl_Position=projectionMatrix*mv;}",fragmentShader:"varying vec3 vColor; varying float vAlpha; void main(){ float d=length(gl_PointCoord-vec2(0.5)); if(d>0.5)discard; float g=pow(1.0-d*2.0,1.5); gl_FragColor=vec4(vColor,g*vAlpha);}",transparent:!0,depthWrite:!1,blending:C})]})}function ft(){const x=u.useRef();u.useRef([]);const p=u.useRef(0),M=u.useMemo(()=>{const l=new Float32Array(1200),o=new Float32Array(400*3),a=new Float32Array(400),r=()=>Math.random();for(let e=0;e<400;e++){const s=r()*Math.PI*2,n=Math.acos(2*r()-1),i=r();let c,d;i<.45?(c=6+r()*6,d=.03):i<.8?(c=12+r()*8,d=.02):(c=20+r()*8,d=.015),l[e*3]=c*Math.sin(n)*Math.cos(s),l[e*3+1]=c*Math.sin(n)*Math.sin(s),l[e*3+2]=c*Math.cos(n);const b=r();b<.4?(o[e*3]=.95,o[e*3+1]=.97,o[e*3+2]=1):b<.55?(o[e*3]=.3,o[e*3+1]=.95,o[e*3+2]=1):b<.68?(o[e*3]=1,o[e*3+1]=1,o[e*3+2]=1):b<.78?(o[e*3]=.6,o[e*3+1]=.8,o[e*3+2]=1):b<.88?(o[e*3]=.95,o[e*3+1]=.35,o[e*3+2]=.9):(o[e*3]=1,o[e*3+1]=.82,o[e*3+2]=.55),a[e]=d+r()*.015}return{positions:l,colors:o,sizes:a}},[]),h=u.useMemo(()=>{const o=new Float32Array(36),a=new Float32Array(36),r=new Float32Array(12),e=new Float32Array(24),s=()=>Math.random();for(let n=0;n<12;n++){const i=s()*Math.PI*2,c=Math.acos(2*s()-1),d=s()<.65?6+s()*8:14+s()*9;o[n*3]=d*Math.sin(c)*Math.cos(i),o[n*3+1]=d*Math.sin(c)*Math.sin(i),o[n*3+2]=d*Math.cos(c);const b=s();let f=[0,.8,1];b<.25?f=[0,.82,1]:b<.45?f=[.1,.92,.7]:b<.6?f=[.05,.55,.95]:b<.78?f=[.15,.75,.88]:f=[.35,.15,.8],a[n*3]=f[0],a[n*3+1]=f[1],a[n*3+2]=f[2],r[n]=120+s()*140,e[n*2]=2+s()*3,e[n*2+1]=s()*100}return{positions:o,colors:a,sizes:r,noise:e}},[]);return j((l,o)=>{p.current+=o;const a=p.current;x.current&&(x.current.rotation.y=a*.0018,x.current.rotation.x=Math.sin(a*.0012)*.012)}),t.jsxs("group",{ref:x,children:[t.jsxs("points",{children:[t.jsxs("bufferGeometry",{children:[t.jsx("bufferAttribute",{attach:"attributes-position",args:[M.positions,3]}),t.jsx("bufferAttribute",{attach:"attributes-aColor",args:[M.colors,3]}),t.jsx("bufferAttribute",{attach:"attributes-aSize",args:[M.sizes,1]})]}),t.jsx("shaderMaterial",{vertexShader:`
            attribute float aSize;
            attribute vec3 aColor;
            varying vec3 vColor;
            varying float vDist;
    ...
    float fbm(vec2 p) {
      ...
      return v;
          ...
          `,transparent:!0,depthWrite:!1,blending:C})]})]})}function Mt({liveData:g,paused:x}){const p=u.useMemo(()=>typeof window>"u"?!1:window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768,[]),M=u.useCallback(r=>{window.__aetherius_addImpact&&window.__aetherius_addImpact(r)},[]),h=u.useRef({intensity:1,pulse:.4,block:null});u.useEffect(()=>{const r=()=>{const s=g||{},n=parseFloat(String(s.volume||"").replace(/[^0-9.]/g,""))||0,i=parseFloat(String(s.gas||"").replace(/[^0-9.]/g,""))||0;let c=.9+Math.min(n/500,.5)+Math.min(i/50,.25)+Math.random()*.15;c=Math.max(.6,Math.min(1.8,c));const d=h.current;d.intensity=c,s.block&&s.block!=="—"&&s.block!==d.block?(d.block=s.block,d.pulse=1):d.pulse=Math.max(.3,(d.pulse||.3)*.94)};r();const e=setInterval(r,400);return()=>clearInterval(e)},[g]);const m=u.useMemo(()=>({position:[0,.3,10.5],fov:40}),[]),l=u.useMemo(()=>({alpha:!0,antialias:!p,powerPreference:"high-performance"}),[p]),o=u.useMemo(()=>({position:"absolute",inset:0,width:"100%",height:"100%",background:"transparent"}),[]),a=u.useMemo(()=>[1,1.5],[]);return t.jsxs(X,{camera:m,gl:l,onCreated:({gl:r})=>r.setClearColor(0,0),style:o,dpr:a,frameloop:x?"demand":"always",children:[t.jsx("ambientLight",{intensity:.05}),t.jsxs("group",{scale:1.3,children:[t.jsx(lt,{flowRef:h}),t.jsx(dt,{liveData:g,onImpact:M,flowRef:h}),t.jsx(at,{liveData:g}),t.jsx(it,{}),t.jsx(rt,{}),t.jsx(st,{}),t.jsx(vt,{}),t.jsx(ut,{}),t.jsx(ot,{})]}),!p&&t.jsxs(t.Fragment,{children:[t.jsx(ft,{}),t.jsx(D,{radius:12,depth:30,count:350,factor:1.2,saturation:.15,fade:!0,speed:.12}),t.jsx(D,{radius:8,depth:15,count:180,factor:.6,saturation:.2,fade:!0,speed:.08}),t.jsx(D,{radius:20,depth:50,count:80,factor:.5,saturation:.1,fade:!0,speed:.05}),t.jsx(ct,{}),t.jsx(ht,{})]}),t.jsx($,{autoRotate:!0,autoRotateSpeed:1,enableZoom:!1,enablePan:!1,enableDamping:!0,dampingFactor:.08,rotateSpeed:.5,minPolarAngle:Math.PI*.25,maxPolarAngle:Math.PI*.75})]})}export{Mt as default};

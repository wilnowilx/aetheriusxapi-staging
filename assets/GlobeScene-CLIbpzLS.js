import{r as f,j as e,C as Y,S as B,O as J,u as P}from"./r3f-BFDIpzVt.js";import{q as L,r as q,p as w,F as R,e as U,s as $,h as z,D as K}from"./three-DAA57BSS.js";const Q=({liveData:g})=>{const x=f.useRef(),p=f.useRef(0),y=f.useMemo(()=>{const o=g||{};return[{radius:3.6,tilt:.18,yOffset:.45,speed:.025,bandWidth:.42,color:"#ffffff",opacity:.9,fontSize:44,text:"THE MARKETPLACE   THAT LIVES   "},{radius:3.05,tilt:.32,yOffset:-.15,speed:-.035,bandWidth:.36,color:"#d946ef",opacity:.78,fontSize:34,text:"API INFRASTRUCTURE   FOR AI AGENTS   THAT PAY   "},{radius:2.55,tilt:.12,yOffset:-.55,speed:.04,bandWidth:.32,color:"#22d3ee",opacity:.68,fontSize:28,text:`${o.endpoints||"100+"} ENDPOINTS   ${o.freeEndpoints||"40"} FREE   ${o.latency||"—"}   `}]},[g]),u=f.useMemo(()=>y.map(o=>{const t=document.createElement("canvas");t.width=4096,t.height=160;const a=t.getContext("2d");a.clearRect(0,0,t.width,t.height);const d=`900 ${o.fontSize*1.35}px 'JetBrains Mono', 'Fira Code', monospace`;a.font=d,a.textAlign="center",a.textBaseline="middle";const s=o.text,h=a.measureText(s).width,n=Math.ceil((t.width+h)/h),b=(t.width-h*n)/2+h/2;a.shadowColor=o.color,a.shadowBlur=48,a.fillStyle=o.color;for(let l=0;l<n;l++)a.fillText(s,b+l*h,t.height/2);a.shadowBlur=22;for(let l=0;l<n;l++)a.fillText(s,b+l*h,t.height/2);a.shadowBlur=0,a.fillStyle=o.color==="#ffffff"?"#ffffff":o.color;for(let l=0;l<n;l++)a.fillText(s,b+l*h,t.height/2);a.fillStyle="#ffffff",a.globalAlpha=.85;for(let l=0;l<n;l++)a.fillText(s,b+l*h,t.height/2);a.globalAlpha=1;const M=new L(t);return M.anisotropy=8,M.minFilter=$,M.magFilter=$,M}),[y]),m=f.useMemo(()=>y.map(o=>{const t=document.createElement("canvas");t.width=4096,t.height=160;const a=t.getContext("2d");a.clearRect(0,0,t.width,t.height),a.font=`900 ${o.fontSize*1.35}px 'JetBrains Mono', 'Fira Code', monospace`,a.textAlign="center",a.textBaseline="middle";const d=o.text,s=a.measureText(d).width,h=Math.ceil((t.width+s)/s),n=(t.width-s*h)/2+s/2;a.shadowColor=o.color,a.shadowBlur=28,a.fillStyle=o.color,a.globalAlpha=.35;for(let M=0;M<h;M++)a.fillText(d,n+M*s,t.height/2);a.globalAlpha=1;const b=new L(t);return b.anisotropy=4,b}),[y]),[c,i]=f.useState(null),r=f.useRef(0);return P((o,t)=>{p.current+=t,r.current+=t,x.current&&y.forEach((a,d)=>{const s=x.current.children[d];if(s){c===d||(s.rotation.y+=t*a.speed);const n=s.children[0];if(n!=null&&n.material){const b=.88+.12*Math.sin(r.current*.7+d*1.2);n.material.opacity=(c===d?1:a.opacity)*b}}})}),e.jsx("group",{ref:x,children:y.map((o,t)=>e.jsxs("group",{position:[0,o.yOffset,0],rotation:[o.tilt,0,0],children:[e.jsxs("mesh",{onPointerOver:a=>{a.stopPropagation(),i(t),document.body.style.cursor="pointer"},onPointerOut:()=>{i(null),document.body.style.cursor="auto"},onClick:()=>{window.__aetherius_addImpact&&window.__aetherius_addImpact({position:new z(o.radius,o.yOffset,0),intensity:.8})},children:[e.jsx("cylinderGeometry",{args:[o.radius,o.radius,o.bandWidth,128,1,!0]}),e.jsx("meshBasicMaterial",{map:u[t],transparent:!0,opacity:o.opacity,side:R,depthWrite:!1,blending:w,toneMapped:!1})]}),e.jsxs("mesh",{children:[e.jsx("cylinderGeometry",{args:[o.radius,o.radius,o.bandWidth,128,1,!0]}),e.jsx("meshBasicMaterial",{map:m[t],transparent:!0,opacity:.22,side:q,depthWrite:!1,blending:w,toneMapped:!1})]}),e.jsxs("mesh",{children:[e.jsx("torusGeometry",{args:[o.radius,o.bandWidth*.06,6,128]}),e.jsx("meshBasicMaterial",{color:o.color,transparent:!0,opacity:o.opacity*.12,depthWrite:!1})]})]},t))})};function Z(){const g=f.useMemo(()=>({time:{value:0},colorA:{value:new U(2282478)},colorB:{value:new U(11032055)},colorC:{value:new U(14239471)}}),[]);return P((x,p)=>{g.time.value+=p*.6}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[2.65,28,20]}),e.jsx("shaderMaterial",{uniforms:g,vertexShader:`
        ...
        `,side:R,transparent:!0,depthWrite:!1,blending:w})]})}function X(){const g=f.useMemo(()=>({time:{value:0}}),[]);return P((x,p)=>{g.time.value+=p*.4}),e.jsxs("mesh",{scale:.85,children:[e.jsx("sphereGeometry",{args:[2.2,32,32]}),e.jsx("shaderMaterial",{uniforms:g,vertexShader:`
        ...
        `,side:R,transparent:!0,depthWrite:!1,blending:w})]})}function tt({impactPoints:g}){const x=f.useRef(),p=f.useMemo(()=>({time:{value:0},impact0:{value:new z(0,0,0)},i0t:{value:0},impact1:{value:new z(0,0,0)},i1t:{value:0},impact2:{value:new z(0,0,0)},i2t:{value:0},impact3:{value:new z(0,0,0)},i3t:{value:0},impact4:{value:new z(0,0,0)},i4t:{value:0},impact5:{value:new z(0,0,0)},i5t:{value:0},impact6:{value:new z(0,0,0)},i6t:{value:0},impact7:{value:new z(0,0,0)},i7t:{value:0}}),[]);return P((y,u)=>{if(p.time.value+=u*.5,g)for(let m=0;m<8&&m<g.length;m++){const c=g[m];p[`impact${m}`].value.copy(c.position),p[`i${m}t`].value=c.intensity}}),e.jsxs("mesh",{ref:x,children:[e.jsx("sphereGeometry",{args:[2.2,36,24]}),e.jsx("shaderMaterial",{uniforms:p,vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:w})]})}function ot({flowRef:g}){const x=f.useRef(),p=f.useRef(0),y=f.useMemo(()=>{const m=document.createElement("canvas");m.width=512,m.height=128;const c=m.getContext("2d");return c.clearRect(0,0,512,128),c.font="bold 72px monospace",c.textAlign="center",c.textBaseline="middle",c.fillStyle="#0052FF",c.shadowColor="#0052FF",c.shadowBlur=30,c.fillText("BASE",256,64),c.shadowBlur=0,c.fillText("BASE",256,64),new L(m)},[]);P((m,c)=>{var r;p.current+=c;const i=(g==null?void 0:g.current)||{pulse:.3};if(i.pulse=Math.max(.25,(i.pulse||0)-c*1.6),x.current){x.current.rotation.y=p.current*.08,x.current.rotation.x=Math.sin(p.current*.12)*.08;const o=Math.sin(p.current*1.5),t=Math.sin(p.current*.9)*.03,a=i.pulse,d=1+.04*o+.18*a;x.current.scale.set(d,d,d),x.current.position.y=t;const s=(r=x.current.children[0])==null?void 0:r.material;s&&(s.opacity=.7+.18*o+.18*a)}});const u=f.useMemo(()=>({time:{value:0},flow:{value:1},pulse:{value:0}}),[]);return P((m,c)=>{var i,r;u.time.value+=c*.5,u.flow.value=((i=g==null?void 0:g.current)==null?void 0:i.intensity)||1,u.pulse.value=((r=g==null?void 0:g.current)==null?void 0:r.pulse)||.3}),e.jsxs("group",{ref:x,scale:1.3,children:[e.jsxs("mesh",{renderOrder:0,children:[e.jsx("sphereGeometry",{args:[1.5,24,18]}),e.jsx("shaderMaterial",{uniforms:u,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:w,side:q})]}),e.jsxs("mesh",{renderOrder:1,children:[e.jsx("sphereGeometry",{args:[1.2,20,14]}),e.jsx("shaderMaterial",{uniforms:u,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:w,side:R})]}),e.jsx(at,{gasUniforms:u})]})}function at({gasUniforms:g}){const m=4.840000000000001,c=f.useRef(),i=f.useRef([]),r=f.useMemo(()=>{const a=new Float32Array(216),d=new Float32Array(216),s=new Float32Array(360),h=new Float32Array(216);for(let n=0;n<72;n++){const b=n>=48;s[n*5]=1.5+Math.random()*2,s[n*5+1]=1+Math.random()*2.5,s[n*5+2]=Math.random()*3,s[n*5+3]=b?1:0,s[n*5+4]=1;const M=Math.random()*Math.PI*2,l=Math.acos(2*Math.random()-1),S=s[n*5];if(d[n*3]=Math.sin(l)*Math.cos(M)*S,d[n*3+1]=Math.sin(l)*Math.sin(M)*S,d[n*3+2]=Math.cos(l)*S,a[n*3]=(Math.random()-.5)*.04,a[n*3+1]=(Math.random()-.5)*.04,a[n*3+2]=(Math.random()-.5)*.04,b){const C=Math.random();h[n*3]=.6+C*.3,h[n*3+1]=.15+C*.2,h[n*3+2]=.85+C*.15}else{const C=Math.random();h[n*3]=.1+C*.9,h[n*3+1]=.6+C*.4,h[n*3+2]=.8+C*.2}}return{positions:a,velocities:d,seeds:s,colors:h}},[]);return P((a,d)=>{if(!c.current)return;const{positions:s,velocities:h,seeds:n,colors:b}=r;g.time.value,g.pulse.value;const M=[];for(let l=0;l<72;l++){const S=n[l*5+3]>.5;n[l*5+2]+=d;const C=n[l*5+2],j=n[l*5+1];if(C>=j){const _=Math.random()*Math.PI*2,A=Math.acos(2*Math.random()-1),T=1.5+Math.random()*2;h[l*3]=Math.sin(A)*Math.cos(_)*T,h[l*3+1]=Math.sin(A)*Math.sin(_)*T,h[l*3+2]=Math.cos(A)*T,s[l*3]=(Math.random()-.5)*.04,s[l*3+1]=(Math.random()-.5)*.04,s[l*3+2]=(Math.random()-.5)*.04,n[l*5]=T,n[l*5+2]=0,n[l*5+4]=1;continue}if(n[l*5+4]<.5)continue;s[l*3]+=h[l*3]*d,s[l*3+1]+=h[l*3+1]*d,s[l*3+2]+=h[l*3+2]*d;const F=S?.97:.992;h[l*3]*=F,h[l*3+1]*=F,h[l*3+2]*=F;const O=s[l*3]**2+s[l*3+1]**2+s[l*3+2]**2;if(O>=m&&n[l*5+4]>.5){const A=2.2/Math.sqrt(O);s[l*3]*=A,s[l*3+1]*=A,s[l*3+2]*=A,M.push({x:s[l*3],y:s[l*3+1],z:s[l*3+2],intensity:S?.6:1}),S?(h[l*3]*=-.3,h[l*3+1]*=-.3,h[l*3+2]*=-.3,n[l*5+2]=n[l*5+1]-.2):(n[l*5+4]=0,n[l*5+2]=n[l*5+1]-.1)}}i.current=M,c.current.geometry.attributes.position.needsUpdate=!0}),e.jsxs("points",{ref:c,renderOrder:10,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[r.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-seeds",args:[r.seeds,5]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[r.colors,3]})]}),e.jsx("shaderMaterial",{uniforms:g,vertexShader:`
  ...
  `,transparent:!0,depthWrite:!1,blending:w})]})}function rt(){const p=f.useRef(),y=f.useRef([]),u=f.useRef(0),m=f.useMemo(()=>{const i=new Float32Array(600),r=new Float32Array(600),o=new Float32Array(200);for(let t=0;t<200;t++){const a=Math.random()*Math.PI*2,d=Math.acos(2*Math.random()-1),s=3+Math.random()*12;i[t*3]=s*Math.sin(d)*Math.cos(a),i[t*3+1]=s*Math.sin(d)*Math.sin(a),i[t*3+2]=s*Math.cos(d);const h=Math.random();h<.5?(r[t*3]=.3,r[t*3+1]=.15,r[t*3+2]=.5):h<.8?(r[t*3]=.1,r[t*3+1]=.4,r[t*3+2]=.5):(r[t*3]=.5,r[t*3+1]=.5,r[t*3+2]=.55),o[t]=.02+Math.random()*.03}return{positions:i,colors:r,sizes:o}},[]),c=f.useMemo(()=>Array.from({length:8},()=>{const i=Math.random()*Math.PI*2,r=Math.acos(2*Math.random()-1),o=5+Math.random()*8,t=Math.random();let a;return t<.25?a=[0,.75,1]:t<.45?a=[.1,.85,.7]:t<.65?a=[.05,.5,.9]:t<.82?a=[.15,.7,.85]:a=[.3,.15,.7],{position:[o*Math.sin(r)*Math.cos(i),o*Math.sin(r)*Math.sin(i),o*Math.cos(r)],scale:1.5+Math.random()*2.5,color:a,rotSpeed:(Math.random()-.5)*.02,bobSpeed:.1+Math.random()*.2,bobAmp:.2+Math.random()*.5,phase:Math.random()*Math.PI*2}}),[]);return P((i,r)=>{u.current+=r,p.current&&(p.current.rotation.y=u.current*.008),y.current.forEach((o,t)=>{if(!o)return;const a=c[t],d=u.current;o.position.x=a.position[0]+Math.sin(d*a.rotSpeed+a.phase)*a.bobAmp,o.position.y=a.position[1]+Math.cos(d*a.bobSpeed+a.phase)*a.bobAmp*.6,o.position.z=a.position[2]+Math.sin(d*a.rotSpeed*.7+a.phase*1.3)*a.bobAmp*.4,o.rotation.y=d*a.rotSpeed*.5,o.rotation.x=Math.sin(d*.1)*.1})}),e.jsxs("group",{ref:p,children:[e.jsxs("points",{children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[m.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[m.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[m.sizes,1]})]}),e.jsx("shaderMaterial",{vertexShader:"attribute float aSize; attribute vec3 aColor; varying vec3 vColor; void main(){vColor=aColor; vec4 mv=modelViewMatrix*vec4(position,1.0); gl_PointSize=aSize*(300.0/-mv.z); gl_Position=projectionMatrix*mv;}",fragmentShader:"varying vec3 vColor; void main(){ float d=length(gl_PointCoord-vec2(0.5)); if(d>0.5)discard; float g=pow(1.0-d*2.0,2.0); gl_FragColor=vec4(vColor,g*0.35);}",transparent:!0,depthWrite:!1,blending:w})]}),c.map((i,r)=>e.jsxs("mesh",{ref:o=>y.current[r]=o,position:i.position,children:[e.jsx("planeGeometry",{args:[i.scale,i.scale]}),e.jsx("shaderMaterial",{uniforms:{color:{value:new U(i.color[0],i.color[1],i.color[2])}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:w,side:K})]},r))]})}function st({liveData:g,onImpact:x,flowRef:p}){const u=f.useRef(0),m=f.useRef(),c=2.2,i=c*c,r=s=>{var l;const h=Math.random()*Math.PI*2,n=Math.acos(2*Math.random()-1),b=Math.max(.5,Math.min(1.8,((l=p==null?void 0:p.current)==null?void 0:l.intensity)||1)),M=(1.6+Math.random()*1)*(.9+.3*b);s[0]=Math.sin(n)*Math.cos(h)*M,s[1]=Math.sin(n)*Math.sin(h)*M,s[2]=Math.cos(n)*M},o=(s,h,n)=>{if(Math.random()<.42)s[n*3]=.08,s[n*3+1]=.85,s[n*3+2]=.55,h[n]=.055+Math.random()*.045;else{const b=Math.random();s[n*3]=.15*(1-b)+.78*b,s[n*3+1]=.45*(1-b)+.35*b,s[n*3+2]=1*(1-b)+.97*b,h[n]=.04+Math.random()*.04}},t=f.useMemo(()=>{const s=new Float32Array(156),h=new Float32Array(156),n=new Float32Array(156),b=new Float32Array(52),M=new Float32Array(52),l=new Float32Array(52),S=new Uint8Array(52);for(let C=0;C<52;C++){const j=Math.random()*.08,F=Math.random()*Math.PI*2,O=Math.acos(2*Math.random()-1);s[C*3]=j*Math.sin(O)*Math.cos(F),s[C*3+1]=j*Math.sin(O)*Math.sin(F),s[C*3+2]=j*Math.cos(O);const _=Math.random()*Math.PI*2,A=Math.acos(2*Math.random()-1),T=1.6+Math.random()*1;h[C*3]=Math.sin(A)*Math.cos(_)*T,h[C*3+1]=Math.sin(A)*Math.sin(_)*T,h[C*3+2]=Math.cos(A)*T,o(n,b,C),M[C]=Math.random()*1.5,l[C]=1.8+Math.random()*.8}return{positions:s,velocities:h,colors:n,sizes:b,lifetimes:M,maxLifetimes:l,hit:S}},[]),a=f.useMemo(()=>({time:{value:0},flow:{value:1}}),[]),d=f.useRef(0);return P((s,h)=>{var G,k;u.current+=h,a.time.value=u.current;const n=Math.max(.5,Math.min(1.8,((G=p==null?void 0:p.current)==null?void 0:G.intensity)||1));a.flow.value=n;const b=((k=p==null?void 0:p.current)==null?void 0:k.pulse)>.95&&u.current-d.current>1.2;b&&(d.current=u.current);const{positions:M,velocities:l,colors:S,sizes:C,lifetimes:j,maxLifetimes:F,hit:O}=t,_=[0,0,0];let A=!1,T=b?8:0;for(let v=0;v<52;v++){j[v]+=h;const V=T>0&&j[v]>.15;if(j[v]>=F[v]||V){V&&T--;const W=Math.random()*.08,N=Math.random()*Math.PI*2,E=Math.acos(2*Math.random()-1);M[v*3]=W*Math.sin(E)*Math.cos(N),M[v*3+1]=W*Math.sin(E)*Math.sin(N),M[v*3+2]=W*Math.cos(E),r(_),l[v*3]=_[0],l[v*3+1]=_[1],l[v*3+2]=_[2],o(S,C,v),A=!0,j[v]=0,F[v]=1.8+Math.random()*.8,O[v]=0;continue}const D=Math.sqrt(M[v*3]*M[v*3]+M[v*3+1]*M[v*3+1]+M[v*3+2]*M[v*3+2]),I=D>1.6?(D-1.6)/.6:0;I>0&&(l[v*3]*=1-I*.08,l[v*3+1]*=1-I*.08,l[v*3+2]*=1-I*.08,C[v]=C[v]*(1+I*.8)),M[v*3]+=l[v*3]*h,M[v*3+1]+=l[v*3+1]*h,M[v*3+2]+=l[v*3+2]*h;const H=M[v*3]*M[v*3]+M[v*3+1]*M[v*3+1]+M[v*3+2]*M[v*3+2];if(H>=i)if(O[v])C[v]*=1.06;else{O[v]=1;const W=Math.sqrt(H),N=c/W;M[v*3]*=N,M[v*3+1]*=N,M[v*3+2]*=N,l[v*3]=0,l[v*3+1]=0,l[v*3+2]=0,x&&x({position:new z(M[v*3],M[v*3+1],M[v*3+2]),intensity:1}),j[v]=F[v]-.8}}m.current&&(m.current.geometry.attributes.position.needsUpdate=!0,A&&(m.current.geometry.attributes.aColor.needsUpdate=!0,m.current.geometry.attributes.aSize.needsUpdate=!0))}),e.jsxs("points",{ref:m,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[t.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[t.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[t.sizes,1]})]}),e.jsx("shaderMaterial",{uniforms:a,vertexShader:`
          attribute float aSize; attribute vec3 aColor;
        ...
        `,transparent:!0,depthWrite:!1,blending:w})]})}function nt(){const g=f.useRef(),x=f.useMemo(()=>({time:{value:0}}),[]),p=f.useRef(0);P((c,i)=>{p.current+=i,x.time.value=p.current,g.current&&(g.current.rotation.y=p.current*.06)});const{positions:y,colors:u,sizes:m}=f.useMemo(()=>{const i=new Float32Array(150),r=new Float32Array(150),o=new Float32Array(50);for(let t=0;t<50;t++){const a=t/50*Math.PI*2,d=t%3,s=2.55+d*.22,h=.15*d;i[t*3]=s*Math.cos(a),i[t*3+1]=s*Math.sin(a)*Math.sin(h),i[t*3+2]=s*Math.sin(a)*Math.cos(h);const n=t/50;r[t*3]=.659*(1-n)+.133*n,r[t*3+1]=.333*(1-n)+.827*n,r[t*3+2]=.969*(1-n)+.933*n,o[t]=.015+Math.random()*.025}return{positions:i,colors:r,sizes:o}},[]);return e.jsx("group",{ref:g,children:e.jsxs("points",{children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[y,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[u,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[m,1]})]}),e.jsx("shaderMaterial",{uniforms:x,vertexShader:`
          ...
          `,transparent:!0,depthWrite:!1,blending:w})]})})}function lt({onImpactsReady:g}){const x=f.useRef([]),p=f.useRef(Array.from({length:8},()=>({position:new z,intensity:0,active:!1,age:0})));return P((y,u)=>{for(;x.current.length>0&&p.current.some(c=>!c.active);){const c=x.current.shift(),i=p.current.find(r=>!r.active);i&&(i.position.copy(c.position),i.intensity=c.intensity,i.active=!0,i.age=0)}const m=.8;p.current.forEach(c=>{c.active&&(c.age+=u,c.intensity=Math.max(0,1-c.age*m),c.intensity<=0&&(c.active=!1))}),g(p.current.filter(c=>c.active).map(c=>({position:c.position,intensity:c.intensity})))}),f.useEffect(()=>(window.__aetherius_addImpact=y=>{x.current.push(y)},()=>{delete window.__aetherius_addImpact}),[]),null}function ct(){const[g,x]=f.useState([]),p=f.useRef(""),y=f.useCallback(u=>{let m=u.length+":";for(let c=0;c<u.length;c++){const i=u[c];m+=i.position.x.toFixed(1)+","+i.position.y.toFixed(1)+","+i.position.z.toFixed(1)+","+i.intensity.toFixed(2)+";"}m!==p.current&&(p.current=m,x(u))},[]);return e.jsxs(e.Fragment,{children:[e.jsx(tt,{impactPoints:g}),e.jsx(lt,{onImpactsReady:y})]})}function dt(){const g=f.useRef(),x=f.useRef(0),{positions:p,colors:y,sizes:u}=f.useMemo(()=>{const i=new Float32Array(24),r=new Float32Array(24),o=new Float32Array(8);for(let t=0;t<8;t++){const a=t/8*Math.PI*2+Math.random()*.5,d=4+Math.random()*2;i[t*3]=d*Math.cos(a),i[t*3+1]=(Math.random()-.5)*3,i[t*3+2]=d*Math.sin(a);const s=Math.random();s<.4?(r[t*3]=.13,r[t*3+1]=.82,r[t*3+2]=.93):s<.7?(r[t*3]=.84,r[t*3+1]=.27,r[t*3+2]=.93):(r[t*3]=.83,r[t*3+1]=.66,r[t*3+2]=.32),o[t]=.08+Math.random()*.06}return{positions:i,colors:r,sizes:o}},[]),m=f.useMemo(()=>({time:{value:0}}),[]);return P((c,i)=>{var o,t,a;x.current+=i,m.time.value=x.current,g.current&&(g.current.rotation.y=x.current*.02);const r=(a=(t=(o=g.current)==null?void 0:o.geometry)==null?void 0:t.attributes)==null?void 0:a.aSize;if(r){for(let d=0;d<8;d++)r.array[d]=.06+.05*Math.sin(x.current*2+d*1.5);r.needsUpdate=!0}}),e.jsxs("points",{ref:g,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[p,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[y,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[u,1]})]}),e.jsx("shaderMaterial",{uniforms:m,vertexShader:"attribute float aSize; attribute vec3 aColor; varying vec3 vColor; varying float vAlpha; uniform float time; void main(){vColor=aColor; vAlpha=0.6+0.4*sin(time*1.2+position.x*2.0); vec4 mv=modelViewMatrix*vec4(position,1.0); gl_PointSize=aSize*(500.0/-mv.z); gl_Position=projectionMatrix*mv;}",fragmentShader:"varying vec3 vColor; varying float vAlpha; void main(){ float d=length(gl_PointCoord-vec2(0.5)); if(d>0.5)discard; float g=pow(1.0-d*2.0,1.5); gl_FragColor=vec4(vColor,g*vAlpha);}",transparent:!0,depthWrite:!1,blending:w})]})}function ht(){const p=f.useRef(),y=f.useRef([]),u=f.useRef(0),m=f.useMemo(()=>{const i=new Float32Array(2400),r=new Float32Array(800*3),o=new Float32Array(800);for(let t=0;t<800;t++){const a=Math.random()*Math.PI*2,d=Math.acos(2*Math.random()-1),s=Math.random();let h;s<.4?h=20+Math.random()*15:s<.8?h=35+Math.random()*20:h=55+Math.random()*15,i[t*3]=h*Math.sin(d)*Math.cos(a),i[t*3+1]=h*Math.sin(d)*Math.sin(a),i[t*3+2]=h*Math.cos(d);const n=Math.random();n<.5?(r[t*3]=.9,r[t*3+1]=.92,r[t*3+2]=1):n<.7?(r[t*3]=.2,r[t*3+1]=.95,r[t*3+2]=1):n<.82?(r[t*3]=1,r[t*3+1]=1,r[t*3+2]=1):n<.9?(r[t*3]=.9,r[t*3+1]=.3,r[t*3+2]=.95):(r[t*3]=1,r[t*3+1]=.85,r[t*3+2]=.6);const b=(h-20)/50;o[t]=.022-b*.01+Math.random()*.015}return{positions:i,colors:r,sizes:o}},[]),c=f.useMemo(()=>Array.from({length:12},()=>{const i=Math.random()*Math.PI*2,r=Math.acos(2*Math.random()-1),o=Math.random()<.65?10+Math.random()*10:20+Math.random()*15,t=Math.random();let a;return t<.3?a=[0,.75,1]:t<.5?a=[.1,.85,.7]:t<.7?a=[.05,.5,.9]:t<.85?a=[.15,.7,.85]:a=[.3,.15,.7],{position:[o*Math.sin(r)*Math.cos(i),o*Math.sin(r)*Math.sin(i),o*Math.cos(r)],scale:3+Math.random()*5,color:a,rotSpeed:(Math.random()-.5)*.015,bobSpeed:.05+Math.random()*.12,bobAmp:.3+Math.random()*.8,phase:Math.random()*Math.PI*2,noiseScale:3+Math.random()*4,noiseOffset:Math.random()*100}}),[]);return P((i,r)=>{u.current+=r;const o=u.current;p.current&&(p.current.rotation.y=o*.003,p.current.rotation.x=Math.sin(o*.002)*.02),y.current.forEach((t,a)=>{if(!t)return;const d=c[a];t.position.x=d.position[0]+Math.sin(o*d.rotSpeed+d.phase)*d.bobAmp,t.position.y=d.position[1]+Math.cos(o*d.bobSpeed+d.phase)*d.bobAmp*.6,t.position.z=d.position[2]+Math.sin(o*d.rotSpeed*.7+d.phase*1.3)*d.bobAmp*.4,t.rotation.y=o*d.rotSpeed*.3,t.rotation.x=Math.sin(o*.05)*.08})}),e.jsxs("group",{ref:p,children:[e.jsxs("points",{children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[m.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[m.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[m.sizes,1]})]}),e.jsx("shaderMaterial",{vertexShader:`
            attribute float aSize; attribute vec3 aColor;
            varying vec3 vColor; varying float vAlpha;
            void main() {
              vColor = aColor;
              vAlpha = 0.7 + 0.3 * sin(position.x * 0.3 + position.z * 0.2);
              vec4 mv = modelViewMatrix * vec4(position, 1.0);
          ...
          `,fragmentShader:`
            ...
            void main() {
              ...
              vec3 col = vColor + vec3(1.0) * core * 0.3;
              gl_FragColor = vec4(col, glow * vAlpha * 0.9);
            }
          `,transparent:!0,depthWrite:!1,blending:w})]}),c.map((i,r)=>e.jsxs("mesh",{ref:o=>y.current[r]=o,position:i.position,scale:[i.scale,i.scale,1],children:[e.jsx("planeGeometry",{args:[1,1]}),e.jsx("shaderMaterial",{uniforms:{color:{value:new U(i.color[0],i.color[1],i.color[2])},noiseScale:{value:i.noiseScale},noiseOffset:{value:i.noiseOffset},time:{value:0}},vertexShader:`
            ...
            `,fragmentShader:`
              ...
              void main() {
                ...
                float alpha = radial * tendrils * 0.22;
                if (alpha < 0.003) discard;
            ...
            `,transparent:!0,depthWrite:!1,blending:w,side:K})]},r))]})}function ut({liveData:g,paused:x}){const p=f.useMemo(()=>typeof window>"u"?!1:window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768,[]),y=f.useCallback(o=>{window.__aetherius_addImpact&&window.__aetherius_addImpact(o)},[]),u=f.useRef({intensity:1,pulse:.4,block:null});f.useEffect(()=>{const o=()=>{const a=g||{},d=parseFloat(String(a.volume||"").replace(/[^0-9.]/g,""))||0,s=parseFloat(String(a.gas||"").replace(/[^0-9.]/g,""))||0;let h=.9+Math.min(d/500,.5)+Math.min(s/50,.25)+Math.random()*.15;h=Math.max(.6,Math.min(1.8,h));const n=u.current;n.intensity=h,a.block&&a.block!=="—"&&a.block!==n.block?(n.block=a.block,n.pulse=1):n.pulse=Math.max(.3,(n.pulse||.3)*.94)};o();const t=setInterval(o,400);return()=>clearInterval(t)},[g]);const m=f.useMemo(()=>({position:[0,.3,10.5],fov:40}),[]),c=f.useMemo(()=>({alpha:!0,antialias:!p,powerPreference:"high-performance"}),[p]),i=f.useMemo(()=>({position:"absolute",inset:0,width:"100%",height:"100%",background:"transparent"}),[]),r=f.useMemo(()=>[1,1.5],[]);return e.jsxs(Y,{camera:m,gl:c,onCreated:({gl:o})=>o.setClearColor(0,0),style:i,dpr:r,frameloop:x?"demand":"always",children:[e.jsx("ambientLight",{intensity:.05}),e.jsxs("group",{scale:1.3,children:[e.jsx(ot,{flowRef:u}),e.jsx(ct,{}),e.jsx(st,{liveData:g,onImpact:y,flowRef:u}),e.jsx(Z,{}),e.jsx(X,{}),e.jsx(it,{}),e.jsx(Q,{liveData:g}),e.jsx(nt,{})]}),!p&&e.jsxs(e.Fragment,{children:[e.jsx(ht,{}),e.jsx(B,{radius:12,depth:30,count:350,factor:1.2,saturation:.15,fade:!0,speed:.12}),e.jsx(B,{radius:8,depth:15,count:180,factor:.6,saturation:.2,fade:!0,speed:.08}),e.jsx(B,{radius:20,depth:50,count:80,factor:.5,saturation:.1,fade:!0,speed:.05}),e.jsx(rt,{}),e.jsx(dt,{})]}),e.jsx(J,{autoRotate:!0,autoRotateSpeed:1,enableZoom:!1,enablePan:!1,enableDamping:!0,dampingFactor:.08,rotateSpeed:.5,minPolarAngle:Math.PI*.25,maxPolarAngle:Math.PI*.75})]})}export{ut as default};

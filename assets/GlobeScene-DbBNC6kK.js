import{r as l,j as t,C as N,S as R,O as W,u as P}from"./r3f-CWToFXIM.js";import{q as E,p as C,e as _,r as F,F as O,h as b}from"./three-D-ovYI32.js";function U(){const s=l.useMemo(()=>({time:{value:0},colorA:{value:new _(11032055)},colorB:{value:new _(14239471)}}),[]);return P((m,i)=>{s.time.value+=i*.4}),t.jsxs("mesh",{scale:1.4,children:[t.jsx("sphereGeometry",{args:[2.2,24,18]}),t.jsx("shaderMaterial",{uniforms:s,vertexShader:`
        ...
        `,side:F,transparent:!0,depthWrite:!1,blending:C})]})}function B(){const s=l.useMemo(()=>({time:{value:0},colorA:{value:new _(2282478)},colorB:{value:new _(11032055)}}),[]);return P((m,i)=>{s.time.value+=i*.8}),t.jsxs("mesh",{scale:1.15,children:[t.jsx("sphereGeometry",{args:[2.2,32,24]}),t.jsx("shaderMaterial",{uniforms:s,vertexShader:`
          varying vec3 vNormal; varying vec3 vWorldPos;
          void main() {
            vNormal = normalize(normalMatrix * normal);
            vWorldPos = (modelMatrix * vec4(position, 1.0)).xyz;
        ...
        `,side:F,transparent:!0,depthWrite:!1,blending:C})]})}function L(){const s=l.useMemo(()=>({time:{value:0}}),[]);return P((m,i)=>{s.time.value+=i*.4}),t.jsxs("mesh",{scale:.85,children:[t.jsx("sphereGeometry",{args:[2.2,32,32]}),t.jsx("shaderMaterial",{uniforms:s,vertexShader:`
        ...
        `,side:O,transparent:!0,depthWrite:!1,blending:C})]})}function G({impactPoints:s}){const m=l.useRef(),i=l.useMemo(()=>({time:{value:0},impact0:{value:new b(0,0,0)},i0t:{value:0},impact1:{value:new b(0,0,0)},i1t:{value:0},impact2:{value:new b(0,0,0)},i2t:{value:0},impact3:{value:new b(0,0,0)},i3t:{value:0},impact4:{value:new b(0,0,0)},i4t:{value:0},impact5:{value:new b(0,0,0)},i5t:{value:0},impact6:{value:new b(0,0,0)},i6t:{value:0},impact7:{value:new b(0,0,0)},i7t:{value:0}}),[]);return P((g,f)=>{if(i.time.value+=f*.5,s)for(let e=0;e<8&&e<s.length;e++){const o=s[e];i[`impact${e}`].value.copy(o.position),i[`i${e}t`].value=o.intensity}}),t.jsxs("mesh",{ref:m,children:[t.jsx("sphereGeometry",{args:[2.2,36,24]}),t.jsx("shaderMaterial",{uniforms:i,vertexShader:`

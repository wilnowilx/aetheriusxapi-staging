import{r as p,j as e,C as Y,S as L,O as K,u as P}from"./r3f-BFDIpzVt.js";import{q as k,r as q,p as w,F as O,e as U,s as $,h as z,D as Q}from"./three-DAA57BSS.js";const X=({liveData:x})=>{const M=p.useRef(),f=p.useRef(0),y=p.useMemo(()=>{const o=x||{};return[{radius:3.6,tilt:.18,yOffset:.45,speed:.025,bandWidth:.42,color:"#ffffff",opacity:.9,fontSize:42,text:"   THE MARKETPLACE   •   THAT LIVES   •   THE MARKETPLACE   •   THAT LIVES   •   "},{radius:3.05,tilt:.32,yOffset:-.15,speed:-.035,bandWidth:.36,color:"#00f0ff",opacity:.82,fontSize:34,text:"   API INFRASTRUCTURE   •   FOR AI AGENTS   •   THAT PAY   •   API INFRASTRUCTURE   •   FOR AI AGENTS   •   THAT PAY   •   "},{radius:2.55,tilt:.12,yOffset:-.55,speed:.04,bandWidth:.32,color:"#0052FF",opacity:.75,fontSize:28,text:`   ${o.endpoints||"100+"} ENDPOINTS   •   ${o.freeEndpoints||"40"} FREE   •   ${o.latency||"—"}   •   ${o.endpoints||"100+"} ENDPOINTS   •   ${o.freeEndpoints||"40"} FREE   •   ${o.latency||"—"}   •   `}]},[x]),h=p.useMemo(()=>y.map(o=>{const t=document.createElement("canvas");t.width=4096,t.height=160;const a=t.getContext("2d");a.clearRect(0,0,t.width,t.height);const d=`900 ${o.fontSize*1.35}px 'JetBrains Mono', 'Fira Code', monospace`;a.font=d,a.textAlign="center",a.textBaseline="middle";const s=o.text,u=a.measureText(s).width,n=Math.ceil((t.width+u)/u),b=(t.width-u*n)/2+u/2;a.shadowColor=o.color,a.shadowBlur=48,a.fillStyle=o.color;for(let c=0;c<n;c++)a.fillText(s,b+c*u,t.height/2);a.shadowBlur=22;for(let c=0;c<n;c++)a.fillText(s,b+c*u,t.height/2);a.shadowBlur=0,a.fillStyle=o.color==="#ffffff"?"#ffffff":o.color;for(let c=0;c<n;c++)a.fillText(s,b+c*u,t.height/2);a.fillStyle="#ffffff",a.globalAlpha=.85;for(let c=0;c<n;c++)a.fillText(s,b+c*u,t.height/2);a.globalAlpha=1;const v=new k(t);return v.anisotropy=8,v.minFilter=$,v.magFilter=$,v}),[y]),m=p.useMemo(()=>y.map(o=>{const t=document.createElement("canvas");t.width=4096,t.height=160;const a=t.getContext("2d");a.clearRect(0,0,t.width,t.height),a.font=`900 ${o.fontSize*1.35}px 'JetBrains Mono', 'Fira Code', monospace`,a.textAlign="center",a.textBaseline="middle";const d=o.text,s=a.measureText(d).width,u=Math.ceil((t.width+s)/s),n=(t.width-s*u)/2+s/2;a.shadowColor=o.color,a.shadowBlur=28,a.fillStyle=o.color,a.globalAlpha=.35;for(let v=0;v<u;v++)a.fillText(d,n+v*s,t.height/2);a.globalAlpha=1;const b=new k(t);return b.anisotropy=4,b}),[y]),[l,i]=p.useState(null),r=p.useRef(0);return P((o,t)=>{f.current+=t,r.current+=t,M.current&&y.forEach((a,d)=>{const s=M.current.children[d];if(s){l===d||(s.rotation.y+=t*a.speed);const n=s.children[0];if(n!=null&&n.material){const b=.88+.12*Math.sin(r.current*.7+d*1.2);n.material.opacity=(l===d?1:a.opacity)*b}}})}),e.jsx("group",{ref:M,children:y.map((o,t)=>e.jsxs("group",{position:[0,o.yOffset,0],rotation:[o.tilt,0,0],children:[e.jsxs("mesh",{onPointerOver:a=>{a.stopPropagation(),i(t),document.body.style.cursor="pointer"},onPointerOut:()=>{i(null),document.body.style.cursor="auto"},onClick:()=>{window.__aetherius_addImpact&&window.__aetherius_addImpact({position:new z(o.radius,o.yOffset,0),intensity:.8})},children:[e.jsx("cylinderGeometry",{args:[o.radius,o.radius,o.bandWidth,128,1,!0]}),e.jsx("meshBasicMaterial",{map:h[t],transparent:!0,opacity:o.opacity,side:O,depthWrite:!1,blending:w,toneMapped:!1})]}),e.jsxs("mesh",{children:[e.jsx("cylinderGeometry",{args:[o.radius,o.radius,o.bandWidth,128,1,!0]}),e.jsx("meshBasicMaterial",{map:m[t],transparent:!0,opacity:.22,side:q,depthWrite:!1,blending:w,toneMapped:!1})]}),e.jsxs("mesh",{children:[e.jsx("torusGeometry",{args:[o.radius,o.bandWidth*.06,6,128]}),e.jsx("meshBasicMaterial",{color:o.color,transparent:!0,opacity:o.opacity*.12,depthWrite:!1})]})]},t))})};function J(){const x=p.useMemo(()=>({time:{value:0},colorA:{value:new U(2282478)},colorB:{value:new U(11032055)},colorC:{value:new U(14239471)}}),[]);return P((M,f)=>{x.time.value+=f*.6}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[2.65,28,20]}),e.jsx("shaderMaterial",{uniforms:x,vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:w})]})}function ot({flowRef:x}){const M=p.useRef(),f=p.useRef(0),y=p.useMemo(()=>{const m=document.createElement("canvas");m.width=512,m.height=128;const l=m.getContext("2d");return l.clearRect(0,0,512,128),l.font="bold 72px monospace",l.textAlign="center",l.textBaseline="middle",l.fillStyle="#0052FF",l.shadowColor="#0052FF",l.shadowBlur=30,l.fillText("BASE",256,64),l.shadowBlur=0,l.fillText("BASE",256,64),new k(m)},[]);P((m,l)=>{var r;f.current+=l;const i=(x==null?void 0:x.current)||{pulse:.3};if(i.pulse=Math.max(.25,(i.pulse||0)-l*1.6),M.current){M.current.rotation.y=f.current*.08,M.current.rotation.x=Math.sin(f.current*.12)*.08;const o=Math.sin(f.current*1.5),t=Math.sin(f.current*.9)*.03,a=i.pulse,d=1+.04*o+.18*a;M.current.scale.set(d,d,d),M.current.position.y=t;const s=(r=M.current.children[0])==null?void 0:r.material;s&&(s.opacity=.7+.18*o+.18*a)}});const h=p.useMemo(()=>({time:{value:0},flow:{value:1},pulse:{value:0}}),[]);return P((m,l)=>{var i,r;h.time.value+=l*.5,h.flow.value=((i=x==null?void 0:x.current)==null?void 0:i.intensity)||1,h.pulse.value=((r=x==null?void 0:x.current)==null?void 0:r.pulse)||.3}),e.jsxs("group",{ref:M,scale:1.3,children:[e.jsxs("mesh",{renderOrder:0,children:[e.jsx("sphereGeometry",{args:[1.5,24,18]}),e.jsx("shaderMaterial",{uniforms:h,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:w,side:O})]}),e.jsx(at,{gasUniforms:h})]})}function at({gasUniforms:x}){const m=4.840000000000001,l=p.useRef(),i=p.useRef([]),r=p.useMemo(()=>{const a=new Float32Array(216),d=new Float32Array(216),s=new Float32Array(360),u=new Float32Array(216);for(let n=0;n<72;n++){const b=n>=48;s[n*5]=1.5+Math.random()*2,s[n*5+1]=1+Math.random()*2.5,s[n*5+2]=Math.random()*3,s[n*5+3]=b?1:0,s[n*5+4]=1;const v=Math.random()*Math.PI*2,c=Math.acos(2*Math.random()-1),S=s[n*5];if(d[n*3]=Math.sin(c)*Math.cos(v)*S,d[n*3+1]=Math.sin(c)*Math.sin(v)*S,d[n*3+2]=Math.cos(c)*S,a[n*3]=(Math.random()-.5)*.04,a[n*3+1]=(Math.random()-.5)*.04,a[n*3+2]=(Math.random()-.5)*.04,b){const C=Math.random();u[n*3]=0,u[n*3+1]=.5+C*.4,u[n*3+2]=.95+C*.05}else{const C=Math.random();u[n*3]=0,u[n*3+1]=.75+C*.25,u[n*3+2]=1}}return{positions:a,velocities:d,seeds:s,colors:u}},[]);return P((a,d)=>{if(!l.current)return;const{positions:s,velocities:u,seeds:n,colors:b}=r;x.time.value,x.pulse.value;const v=[];for(let c=0;c<72;c++){const S=n[c*5+3]>.5;n[c*5+2]+=d;const C=n[c*5+2],j=n[c*5+1];if(C>=j){const T=Math.random()*Math.PI*2,A=Math.acos(2*Math.random()-1),_=1.5+Math.random()*2;u[c*3]=Math.sin(A)*Math.cos(T)*_,u[c*3+1]=Math.sin(A)*Math.sin(T)*_,u[c*3+2]=Math.cos(A)*_,s[c*3]=(Math.random()-.5)*.04,s[c*3+1]=(Math.random()-.5)*.04,s[c*3+2]=(Math.random()-.5)*.04,n[c*5]=_,n[c*5+2]=0,n[c*5+4]=1;continue}if(n[c*5+4]<.5)continue;s[c*3]+=u[c*3]*d,s[c*3+1]+=u[c*3+1]*d,s[c*3+2]+=u[c*3+2]*d;const F=S?.97:.992;u[c*3]*=F,u[c*3+1]*=F,u[c*3+2]*=F;const R=s[c*3]**2+s[c*3+1]**2+s[c*3+2]**2;if(R>=m&&n[c*5+4]>.5){const A=2.2/Math.sqrt(R);s[c*3]*=A,s[c*3+1]*=A,s[c*3+2]*=A,v.push({x:s[c*3],y:s[c*3+1],z:s[c*3+2],intensity:S?.6:1}),S?(u[c*3]*=-.3,u[c*3+1]*=-.3,u[c*3+2]*=-.3,n[c*5+2]=n[c*5+1]-.2):(n[c*5+4]=0,n[c*5+2]=n[c*5+1]-.1)}}i.current=v,l.current.geometry.attributes.position.needsUpdate=!0}),e.jsxs("points",{ref:l,renderOrder:10,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[r.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-seeds",args:[r.seeds,5]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[r.colors,3]})]}),e.jsx("shaderMaterial",{uniforms:x,vertexShader:`

import{j as e,r as v,u as P,C as Y,S as D,O as $}from"./r3f-Cah4C2bQ.js";import{u as q}from"./index-BNSBcQiN.js";import{p as C,e as O,q as X,F as w,r as K,s as H,D as Q,h as Z}from"./three-C2wmJeoR.js";import"./gsap-CzGW6FVa.js";const S=500;function J({reputationParticles:h}){const g=v.useRef();h.length;const{positions:m,colors:M,sizes:f,alphas:x,types:p}=v.useMemo(()=>{const r=new Float32Array(S*3),o=new Float32Array(S*3),a=new Float32Array(S),t=new Float32Array(S),s=new Float32Array(S);for(let i=0;i<S;i++)r[i*3]=0,r[i*3+1]=0,r[i*3+2]=0,o[i*3]=0,o[i*3+1]=0,o[i*3+2]=0,a[i]=0,t[i]=0,s[i]=0;return{positions:r,colors:o,sizes:a,alphas:t,types:s}},[]);return P((r,o)=>{if(!g.current)return;const{positions:a,colors:t,sizes:s,alphas:i,types:n}=g.current.geometry.attributes;for(let l=0;l<Math.min(h.length,S);l++){const u=h[l];a.array[l*3]=u.position[0],a.array[l*3+1]=u.position[1],a.array[l*3+2]=u.position[2];const b=new O(u.color);t.array[l*3]=b.r,t.array[l*3+1]=b.g,t.array[l*3+2]=b.b;const c=u.age/u.maxAge,y=c<.1?c/.1:1,E=c>.7?(1-c)/.3:1,A=Math.min(y,E);s.array[l]=u.size*(1+c*.5)*A,i.array[l]=A*(.6+.4*Math.sin(Date.now()*.003+l)),n.array[l]=u.isBatch?1:0}for(let l=h.length;l<S;l++)i.array[l]=0,s.array[l]=0;a.needsUpdate=!0,t.needsUpdate=!0,s.needsUpdate=!0,i.needsUpdate=!0,n.needsUpdate=!0}),e.jsxs("points",{ref:g,renderOrder:15,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[m,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[M,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[f,1]}),e.jsx("bufferAttribute",{attach:"attributes-aAlpha",args:[x,1]}),e.jsx("bufferAttribute",{attach:"attributes-aType",args:[p,1]})]}),e.jsx("shaderMaterial",{vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function tt(){const h=q();return h.length===0?null:e.jsx(J,{reputationParticles:h})}const et=({liveData:h})=>{const g=v.useRef(),m=v.useRef(0),M=v.useMemo(()=>{const o=h||{};return[{radius:2.05,tilt:.15,yOffset:.4,speed:.015,bandWidth:.24,color:"#ffffff",opacity:.85,fontSize:38,text:"   THE MARKETPLACE THAT LIVES   THE MARKETPLACE THAT LIVES   THE MARKETPLACE THAT LIVES   "},{radius:1.72,tilt:-.1,yOffset:0,speed:-.025,bandWidth:.19,color:"#d946ef",opacity:.8,fontSize:30,text:"   API INFRASTRUCTURE FOR AI AGENTS THAT PAY   API INFRASTRUCTURE FOR AI AGENTS THAT PAY   "},{radius:1.42,tilt:.06,yOffset:-.4,speed:.035,bandWidth:.14,color:"#22d3ee",opacity:.75,fontSize:26,text:`   ${o.endpoints||"100+"} ENDPOINTS  ·  ${o.freeEndpoints||"40"} FREE  ·  ${o.latency||""}   ${o.endpoints||"100+"} ENDPOINTS  ·  ${o.freeEndpoints||"40"} FREE  ·  ${o.latency||""}   `}]},[h]),f=v.useMemo(()=>M.map(o=>{const a=document.createElement("canvas");a.width=2048,a.height=80;const t=a.getContext("2d");t.clearRect(0,0,a.width,a.height);const s=`900 ${o.fontSize}px 'JetBrains Mono', 'Fira Code', monospace`;t.font=s,t.textAlign="center",t.textBaseline="middle";const i=o.text,n=t.measureText(i).width,l=Math.ceil((a.width+n)/n),u=(a.width-n*l)/2+n/2;t.shadowColor=o.color,t.shadowBlur=40,t.fillStyle=o.color,t.globalAlpha=.4;for(let c=0;c<l;c++)t.fillText(i,u+c*n,a.height/2);t.shadowBlur=16,t.globalAlpha=.7;for(let c=0;c<l;c++)t.fillText(i,u+c*n,a.height/2);t.shadowBlur=3,t.globalAlpha=1,t.fillStyle=o.color;for(let c=0;c<l;c++)t.fillText(i,u+c*n,a.height/2);t.shadowBlur=0,t.fillStyle="#ffffff",t.globalAlpha=.55;for(let c=0;c<l;c++)t.fillText(i,u+c*n,a.height/2);t.globalAlpha=1;const b=new K(a);return b.anisotropy=4,b.minFilter=H,b.magFilter=H,b}),[M]),[x,p]=v.useState(null),r=v.useRef(0);return P((o,a)=>{m.current+=a,r.current+=a,g.current&&M.forEach((t,s)=>{const i=g.current.children[s];if(i){x===s||(i.rotation.y+=a*t.speed);const l=i.children[0];if(l!=null&&l.material){const u=.88+.12*Math.sin(r.current*.6+s*1.5);l.material.opacity=(x===s?1:t.opacity)*u}}})}),e.jsx("group",{ref:g,children:M.map((o,a)=>e.jsx("group",{position:[0,o.yOffset,0],rotation:[o.tilt,0,0],children:e.jsxs("mesh",{onPointerOver:t=>{t.stopPropagation(),p(a),document.body.style.cursor="pointer"},onPointerOut:()=>{p(null),document.body.style.cursor="auto"},onClick:()=>{},children:[e.jsx("cylinderGeometry",{args:[o.radius,o.radius,o.bandWidth,128,1,!0]}),e.jsx("meshBasicMaterial",{map:f[a],transparent:!0,opacity:o.opacity,side:w,depthWrite:!1,blending:C,toneMapped:!1})]})},a))})};function ot(){const h=v.useMemo(()=>({time:{value:0},colorA:{value:new O(2282478)},colorB:{value:new O(11032055)},colorC:{value:new O(14239471)}}),[]);return P((g,m)=>{h.time.value+=m*.6}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[2.65,28,20]}),e.jsx("shaderMaterial",{uniforms:h,vertexShader:`
        ...
        `,side:w,transparent:!0,depthWrite:!1,blending:C})]})}function at(){const h=v.useMemo(()=>({time:{value:0}}),[]);return P((g,m)=>{h.time.value+=m*.4}),e.jsxs("mesh",{scale:.85,children:[e.jsx("sphereGeometry",{args:[2.2,32,32]}),e.jsx("shaderMaterial",{uniforms:h,vertexShader:`
        ...
        `,side:w,transparent:!0,depthWrite:!1,blending:C})]})}function rt(){const h=v.useRef(),g=v.useMemo(()=>({time:{value:0}}),[]);return P((m,M)=>{g.time.value+=M*.5}),e.jsxs("mesh",{ref:h,children:[e.jsx("sphereGeometry",{args:[2.2,36,24]}),e.jsx("shaderMaterial",{uniforms:g,vertexShader:`
          varying vec3 vPos;
          uniform float time;
          void main() {
            vPos = position;
        ...
        `,wireframe:!0,transparent:!0,depthWrite:!0})]})}function st({gasUniforms:h}){const m=v.useRef(),M=v.useRef(0),f=v.useMemo(()=>{const x=new Float32Array(120),p=new Float32Array(120),r=new Float32Array(120),o=new Float32Array(40);for(let a=0;a<40;a++){const t=Math.random()*Math.PI*2,s=Math.acos(2*Math.random()-1),i=.15+Math.random()*.5;x[a*3]=i*Math.sin(s)*Math.cos(t)*2,x[a*3+1]=i*Math.cos(s)*.7,x[a*3+2]=i*Math.sin(s)*Math.sin(t)*.9,p[a*3]=1.5+Math.random()*5,p[a*3+1]=1+Math.random()*4,p[a*3+2]=1.5+Math.random()*4.5;const n=Math.random();n<.4?(r[a*3]=.1+n*.2,r[a*3+1]=.7+n*.3,r[a*3+2]=.9+n*.1):n<.7?(r[a*3]=.8,r[a*3+1]=.9,r[a*3+2]=1):(r[a*3]=.05,r[a*3+1]=.5+n*.3,r[a*3+2]=.9+n*.1),o[a]=.025+Math.random()*.04}return{positions:x,seeds:p,colors:r,sizes:o}},[]);return P((x,p)=>{var a,t,s,i;M.current+=p;const r=M.current,o=(i=(s=(t=(a=m.current)==null?void 0:a.geometry)==null?void 0:t.attributes)==null?void 0:s.position)==null?void 0:i.array;if(o){for(let n=0;n<40;n++){const l=f.seeds[n*3],u=f.seeds[n*3+1],b=f.seeds[n*3+2];o[n*3]=f.positions[n*3]+Math.sin(r*l+n*.7)*.05,o[n*3+1]=f.positions[n*3+1]+Math.cos(r*u+n*1.1)*.035,o[n*3+2]=f.positions[n*3+2]+Math.sin(r*b+n*.9)*.04}m.current.geometry.attributes.position.needsUpdate=!0}}),e.jsxs("points",{ref:m,renderOrder:2,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[f.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[f.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[f.sizes,1]})]}),e.jsx("shaderMaterial",{uniforms:h,vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function it({flowRef:h}){const g=v.useRef(),m=v.useRef(0),M=v.useMemo(()=>[{pos:[-.39+.18/2,0,0],size:[.18,.18,.06]},{pos:[-.39+.0756/2,.1278,0],size:[.0756,.0756,.06]},{pos:[-.39+.18+.02+.18/2,0,0],size:[.18,.18,.06]},{pos:[-.39+2*(.18+.02)+.18/2,0,0],size:[.18,.18,.06]},{pos:[-.39+3*(.18+.02)+.18/2,0,0],size:[.18,.18,.06]}],[]);P((x,p)=>{m.current+=p;const r=(h==null?void 0:h.current)||{pulse:.3};if(r.pulse=Math.max(.25,(r.pulse||0)-p*1.6),g.current){g.current.rotation.y=m.current*.08,g.current.rotation.x=Math.sin(m.current*.12)*.08;const o=Math.sin(m.current*1.5),a=Math.sin(m.current*.9)*.03,t=r.pulse*.5,s=1+.03*o+.08*t;g.current.scale.set(s,s,s),g.current.position.y=a;const i=g.current.children[0];i!=null&&i.isGroup&&i.children.forEach(n=>{n!=null&&n.material&&(n.material.opacity=.65+.15*o+.1*t)})}});const f=v.useMemo(()=>({time:{value:0},flow:{value:1},pulse:{value:0}}),[]);return P((x,p)=>{var r,o;f.time.value+=p*.5,f.flow.value=((r=h==null?void 0:h.current)==null?void 0:r.intensity)||1,f.pulse.value=(((o=h==null?void 0:h.current)==null?void 0:o.pulse)||.3)*.4}),e.jsxs("group",{ref:g,scale:1.3,children:[e.jsxs("mesh",{renderOrder:0,children:[e.jsx("sphereGeometry",{args:[1.5,24,18]}),e.jsx("shaderMaterial",{uniforms:f,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:X})]}),e.jsxs("mesh",{renderOrder:1,children:[e.jsx("sphereGeometry",{args:[1.2,20,14]}),e.jsx("shaderMaterial",{uniforms:f,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:w})]}),e.jsx("group",{renderOrder:-1,children:M.map((x,p)=>e.jsxs("mesh",{position:x.pos,children:[e.jsx("boxGeometry",{args:x.size}),e.jsx("meshBasicMaterial",{color:"#0052FF",transparent:!0,opacity:.7,blending:C,depthWrite:!1,toneMapped:!1})]},p))}),e.jsx(st,{gasUniforms:f}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[.38,32,24]}),e.jsx("shaderMaterial",{uniforms:f,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float flow; uniform float pulse;
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:w})]}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[.62,24,18]}),e.jsx("shaderMaterial",{uniforms:f,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float flow; uniform float pulse;
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:w})]}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[.88,16,12]}),e.jsx("shaderMaterial",{uniforms:f,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              alpha *= smoothstep(1.0, 0.3, dist);
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:w})]}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[1.45,20,16]}),e.jsx("shaderMaterial",{uniforms:f,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float pulse;
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:w})]})]})}function nt(){const m=v.useRef(),M=v.useRef([]),f=v.useRef(0),x=v.useMemo(()=>{const r=new Float32Array(600),o=new Float32Array(600),a=new Float32Array(200);for(let t=0;t<200;t++){const s=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1),n=4.8+Math.random()*12;r[t*3]=n*Math.sin(i)*Math.cos(s),r[t*3+1]=n*Math.sin(i)*Math.sin(s),r[t*3+2]=n*Math.cos(i);const l=Math.random();l<.5?(o[t*3]=0,o[t*3+1]=.85,o[t*3+2]=1):l<.8?(o[t*3]=0,o[t*3+1]=.4,o[t*3+2]=1):(o[t*3]=.1,o[t*3+1]=.9,o[t*3+2]=.7),a[t]=.012+Math.random()*.02}return{positions:r,colors:o,sizes:a}},[]),p=v.useMemo(()=>Array.from({length:6},()=>{const r=Math.random()*Math.PI*2,o=Math.acos(2*Math.random()-1),a=5.5+Math.random()*8.5,t=Math.random();let s;return t<.4?s=[0,.82,1]:t<.7?s=[0,.45,.95]:s=[.1,.88,.72],{position:[a*Math.sin(o)*Math.cos(r),a*Math.sin(o)*Math.sin(r),a*Math.cos(o)],scale:1.8+Math.random()*2.5,color:s,rotSpeed:(Math.random()-.5)*.02,bobSpeed:.1+Math.random()*.2,bobAmp:.2+Math.random()*.4,phase:Math.random()*Math.PI*2}}),[]);return P((r,o)=>{f.current+=o,m.current&&(m.current.rotation.y=f.current*.008),M.current.forEach((a,t)=>{if(!a)return;const s=p[t],i=f.current;a.position.x=s.position[0]+Math.sin(i*s.rotSpeed+s.phase)*s.bobAmp,a.position.y=s.position[1]+Math.cos(i*s.bobSpeed+s.phase)*s.bobAmp*.6,a.position.z=s.position[2]+Math.sin(i*s.rotSpeed*.7+s.phase*1.3)*s.bobAmp*.4})}),e.jsxs("group",{ref:m,children:[e.jsxs("points",{children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[x.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[x.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[x.sizes,1]})]}),e.jsx("shaderMaterial",{vertexShader:`
          ...
          `,transparent:!0,depthWrite:!1,blending:C})]}),p.map((r,o)=>e.jsxs("mesh",{ref:a=>M.current[o]=a,position:r.position,children:[e.jsx("planeGeometry",{args:[1,1]}),e.jsx("shaderMaterial",{uniforms:{color:{value:new O(r.color[0],r.color[1],r.color[2])},scaleVal:{value:r.scale}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:C,side:Q})]},o))]})}function lt({liveData:h,onImpact:g,flowRef:m}){const f=v.useRef(0),x=v.useRef(),p=2.2,r=p*p,o=n=>{var y;const l=Math.random()*Math.PI*2,u=Math.acos(2*Math.random()-1),b=Math.max(.5,Math.min(1.8,((y=m==null?void 0:m.current)==null?void 0:y.intensity)||1)),c=(1.6+Math.random()*1)*(.9+.3*b);n[0]=Math.sin(u)*Math.cos(l)*c,n[1]=Math.sin(u)*Math.sin(l)*c,n[2]=Math.cos(u)*c},a=(n,l,u)=>{Math.random()<.5?(n[u*3]=0,n[u*3+1]=.85,n[u*3+2]=1,l[u]=.04+Math.random()*.03):(n[u*3]=0,n[u*3+1]=.4,n[u*3+2]=1,l[u]=.035+Math.random()*.03)},t=v.useMemo(()=>{const n=new Float32Array(105),l=new Float32Array(105),u=new Float32Array(105),b=new Float32Array(35),c=new Float32Array(35),y=new Float32Array(35),E=new Uint8Array(35);for(let A=0;A<35;A++){const j=Math.random()*.08,T=Math.random()*Math.PI*2,z=Math.acos(2*Math.random()-1);n[A*3]=j*Math.sin(z)*Math.cos(T),n[A*3+1]=j*Math.sin(z)*Math.sin(T),n[A*3+2]=j*Math.cos(z);const _=Math.random()*Math.PI*2,F=Math.acos(2*Math.random()-1),N=1.6+Math.random()*1;l[A*3]=Math.sin(F)*Math.cos(_)*N,l[A*3+1]=Math.sin(F)*Math.sin(_)*N,l[A*3+2]=Math.cos(F)*N,a(u,b,A),c[A]=Math.random()*1.5,y[A]=1.8+Math.random()*.8}return{positions:n,velocities:l,colors:u,sizes:b,lifetimes:c,maxLifetimes:y,hit:E}},[]),s=v.useMemo(()=>({time:{value:0},flow:{value:1}}),[]),i=v.useRef(0);return P((n,l)=>{var G,L;f.current+=l,s.time.value=f.current;const u=Math.max(.5,Math.min(1.8,((G=m==null?void 0:m.current)==null?void 0:G.intensity)||1));s.flow.value=u;const b=((L=m==null?void 0:m.current)==null?void 0:L.pulse)>.95&&f.current-i.current>1.2;b&&(i.current=f.current);const{positions:c,velocities:y,colors:E,sizes:A,lifetimes:j,maxLifetimes:T,hit:z}=t,_=[0,0,0];let F=!1,N=b?3:0;for(let d=0;d<35;d++){j[d]+=l;const k=N>0&&j[d]>.15;if(j[d]>=T[d]||k){k&&N--;const I=Math.random()*.08,U=Math.random()*Math.PI*2,W=Math.acos(2*Math.random()-1);c[d*3]=I*Math.sin(W)*Math.cos(U),c[d*3+1]=I*Math.sin(W)*Math.sin(U),c[d*3+2]=I*Math.cos(W),o(_),y[d*3]=_[0],y[d*3+1]=_[1],y[d*3+2]=_[2],a(E,A,d),F=!0,j[d]=0,T[d]=1.8+Math.random()*.8,z[d]=0;continue}const V=Math.sqrt(c[d*3]*c[d*3]+c[d*3+1]*c[d*3+1]+c[d*3+2]*c[d*3+2]),R=V>1.6?(V-1.6)/.6:0;R>0&&(y[d*3]*=1-R*.08,y[d*3+1]*=1-R*.08,y[d*3+2]*=1-R*.08,A[d]=A[d]*(1+R*.8)),c[d*3]+=y[d*3]*l,c[d*3+1]+=y[d*3+1]*l,c[d*3+2]+=y[d*3+2]*l;const B=c[d*3]*c[d*3]+c[d*3+1]*c[d*3+1]+c[d*3+2]*c[d*3+2];if(B>=r)if(z[d])A[d]*=1.06;else{z[d]=1;const I=Math.sqrt(B),U=p/I;c[d*3]*=U,c[d*3+1]*=U,c[d*3+2]*=U,y[d*3]=0,y[d*3+1]=0,y[d*3+2]=0,g&&g({position:new Z(c[d*3],c[d*3+1],c[d*3+2]),intensity:1}),j[d]=T[d]-.8}}x.current&&(x.current.geometry.attributes.position.needsUpdate=!0,F&&(x.current.geometry.attributes.aColor.needsUpdate=!0,x.current.geometry.attributes.aSize.needsUpdate=!0))}),e.jsxs("points",{ref:x,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[t.positions,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[t.colors,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[t.sizes,1]})]}),e.jsx("shaderMaterial",{uniforms:s,vertexShader:`
          attribute float aSize; attribute vec3 aColor;
    ...
    float fbm(vec2 p) {
      ...
      return v;
          ...
          `,transparent:!0,depthWrite:!1,blending:C})]})]})}function gt({liveData:h,paused:g}){const m=v.useMemo(()=>typeof window>"u"?!1:window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768,[]),M=v.useCallback(a=>{window.__aetherius_addImpact&&window.__aetherius_addImpact(a)},[]),f=v.useRef({intensity:1,pulse:.4,block:null});v.useEffect(()=>{const a=()=>{const s=h||{},i=parseFloat(String(s.volume||"").replace(/[^0-9.]/g,""))||0,n=parseFloat(String(s.gas||"").replace(/[^0-9.]/g,""))||0;let l=.9+Math.min(i/500,.5)+Math.min(n/50,.25)+Math.random()*.15;l=Math.max(.6,Math.min(1.8,l));const u=f.current;u.intensity=l,s.block&&s.block!=="—"&&s.block!==u.block?(u.block=s.block,u.pulse=1):u.pulse=Math.max(.3,(u.pulse||.3)*.94)};a();const t=setInterval(a,400);return()=>clearInterval(t)},[h]);const x=v.useMemo(()=>({position:[0,.3,10.5],fov:40}),[]),p=v.useMemo(()=>({alpha:!0,antialias:!m,powerPreference:"high-performance"}),[m]),r=v.useMemo(()=>({position:"absolute",inset:0,width:"100%",height:"100%",background:"transparent"}),[]),o=v.useMemo(()=>[1,1.5],[]);return e.jsxs(Y,{camera:x,gl:p,onCreated:({gl:a})=>a.setClearColor(0,0),style:r,dpr:o,frameloop:g?"demand":"always",children:[e.jsx("ambientLight",{intensity:.05}),e.jsxs("group",{scale:1.3,children:[e.jsx(it,{flowRef:f}),e.jsx(lt,{liveData:h,onImpact:M,flowRef:f}),e.jsx(et,{liveData:h}),e.jsx(rt,{}),e.jsx(ot,{}),e.jsx(at,{}),e.jsx(ct,{}),e.jsx(ut,{}),e.jsx(tt,{})]}),!m&&e.jsxs(e.Fragment,{children:[e.jsx(vt,{}),e.jsx(D,{radius:12,depth:30,count:350,factor:1.2,saturation:.15,fade:!0,speed:.12}),e.jsx(D,{radius:8,depth:15,count:180,factor:.6,saturation:.2,fade:!0,speed:.08}),e.jsx(D,{radius:20,depth:50,count:80,factor:.5,saturation:.1,fade:!0,speed:.05}),e.jsx(nt,{}),e.jsx(dt,{})]}),e.jsx($,{autoRotate:!0,autoRotateSpeed:1,enableZoom:!1,enablePan:!1,enableDamping:!0,dampingFactor:.08,rotateSpeed:.5,minPolarAngle:Math.PI*.25,maxPolarAngle:Math.PI*.75})]})}export{gt as default};

import{j as e,r as f,u as P,C as q,S as B,O as X}from"./r3f-DD-zEP2Y.js";import{u as K}from"./index-NbBbyRXH.js";import{p as C,e as O,q as G,r as Y,F as j,s as $,D as J,h as Q}from"./three-DAA57BSS.js";import"./gsap-CzGW6FVa.js";const S=500;function Z({reputationParticles:v}){const g=f.useRef();v.length;const{positions:m,colors:y,sizes:p,alphas:x,types:d}=f.useMemo(()=>{const r=new Float32Array(S*3),s=new Float32Array(S*3),o=new Float32Array(S),t=new Float32Array(S),a=new Float32Array(S);for(let n=0;n<S;n++)r[n*3]=0,r[n*3+1]=0,r[n*3+2]=0,s[n*3]=0,s[n*3+1]=0,s[n*3+2]=0,o[n]=0,t[n]=0,a[n]=0;return{positions:r,colors:s,sizes:o,alphas:t,types:a}},[]);return P((r,s)=>{if(!g.current)return;const{positions:o,colors:t,sizes:a,alphas:n,types:i}=g.current.geometry.attributes;for(let l=0;l<Math.min(v.length,S);l++){const c=v[l];o.array[l*3]=c.position[0],o.array[l*3+1]=c.position[1],o.array[l*3+2]=c.position[2];const b=new O(c.color);t.array[l*3]=b.r,t.array[l*3+1]=b.g,t.array[l*3+2]=b.b;const u=c.age/c.maxAge,M=u<.1?u/.1:1,E=u>.7?(1-u)/.3:1,A=Math.min(M,E);a.array[l]=c.size*(1+u*.5)*A,n.array[l]=A*(.6+.4*Math.sin(Date.now()*.003+l)),i.array[l]=c.isBatch?1:0}for(let l=v.length;l<S;l++)n.array[l]=0,a.array[l]=0;o.needsUpdate=!0,t.needsUpdate=!0,a.needsUpdate=!0,n.needsUpdate=!0,i.needsUpdate=!0}),e.jsxs("points",{ref:g,renderOrder:15,children:[e.jsxs("bufferGeometry",{children:[e.jsx("bufferAttribute",{attach:"attributes-position",args:[m,3]}),e.jsx("bufferAttribute",{attach:"attributes-aColor",args:[y,3]}),e.jsx("bufferAttribute",{attach:"attributes-aSize",args:[p,1]}),e.jsx("bufferAttribute",{attach:"attributes-aAlpha",args:[x,1]}),e.jsx("bufferAttribute",{attach:"attributes-aType",args:[d,1]})]}),e.jsx("shaderMaterial",{vertexShader:`
        ...
        `,side:j,transparent:!0,depthWrite:!1,blending:C})]})}function at(){const v=f.useMemo(()=>({time:{value:0}}),[]);return P((g,m)=>{v.time.value+=m*.4}),e.jsxs("mesh",{scale:.85,children:[e.jsx("sphereGeometry",{args:[2.2,32,32]}),e.jsx("shaderMaterial",{uniforms:v,vertexShader:`
        ...
        `,side:j,transparent:!0,depthWrite:!1,blending:C})]})}function rt(){const v=f.useRef(),g=f.useMemo(()=>({time:{value:0}}),[]);return P((m,y)=>{g.time.value+=y*.5}),e.jsxs("mesh",{ref:v,children:[e.jsx("sphereGeometry",{args:[2.2,36,24]}),e.jsx("shaderMaterial",{uniforms:g,vertexShader:`
          varying vec3 vPos;
          uniform float time;
          void main() {
            vPos = position;
        ...
        `,transparent:!0,depthWrite:!1,blending:C})]})}function it({flowRef:v}){const g=f.useRef(),m=f.useRef(0),y=f.useMemo(()=>{const x=document.createElement("canvas");x.width=512,x.height=128;const d=x.getContext("2d");return d.clearRect(0,0,512,128),d.font="bold 72px monospace",d.textAlign="center",d.textBaseline="middle",d.fillStyle="#0052FF",d.shadowColor="#0052FF",d.shadowBlur=30,d.fillText("BASE",256,64),d.shadowBlur=0,d.fillText("BASE",256,64),new G(x)},[]);P((x,d)=>{var s;m.current+=d;const r=(v==null?void 0:v.current)||{pulse:.3};if(r.pulse=Math.max(.25,(r.pulse||0)-d*1.6),g.current){g.current.rotation.y=m.current*.08,g.current.rotation.x=Math.sin(m.current*.12)*.08;const o=Math.sin(m.current*1.5),t=Math.sin(m.current*.9)*.03,a=r.pulse,n=1+.04*o+.18*a;g.current.scale.set(n,n,n),g.current.position.y=t;const i=(s=g.current.children[0])==null?void 0:s.material;i&&(i.opacity=.7+.18*o+.18*a)}});const p=f.useMemo(()=>({time:{value:0},flow:{value:1},pulse:{value:0}}),[]);return P((x,d)=>{var r,s;p.time.value+=d*.5,p.flow.value=((r=v==null?void 0:v.current)==null?void 0:r.intensity)||1,p.pulse.value=((s=v==null?void 0:v.current)==null?void 0:s.pulse)||.3}),e.jsxs("group",{ref:g,scale:1.3,children:[e.jsxs("mesh",{renderOrder:0,children:[e.jsx("sphereGeometry",{args:[1.5,24,18]}),e.jsx("shaderMaterial",{uniforms:p,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:j})]}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[.62,24,18]}),e.jsx("shaderMaterial",{uniforms:p,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float flow; uniform float pulse;
            void main(){
              ...
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:j})]}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[.88,16,12]}),e.jsx("shaderMaterial",{uniforms:p,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            ...
            void main(){
              ...
              alpha *= smoothstep(1.0, 0.3, dist);
              gl_FragColor = vec4(col, alpha);
            }`,transparent:!0,depthWrite:!1,blending:C,side:j})]}),e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[1.45,20,16]}),e.jsx("shaderMaterial",{uniforms:p,vertexShader:"varying vec3 vPos; void main(){ vPos=position; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }",fragmentShader:`
            varying vec3 vPos; uniform float time; uniform float pulse;
            void main(){
